...
class Slide extends CI_Controller
{
    ...
    public function AddSlides($fileName = '', $fileId = '')
    {
        ...
        $imageInfo = explode(",", urldecode($fileName));
                    ...
                    if ($specimen_data == '') {
					  ...
					  // exit;
					    if (!$blocksInfo) {
                            ...
                            $blockSlides['url'] = "https://slides.fnqhpathology.com.au/slide/".$fileId."/";
                            $blockSlides['thumbnail'] = "https://slides.fnqhpathology.com.au/slide/".$fileId."/fullthumbnail";
