...
//        pre($data);
    ...
    public function update_client_report()
    {
        ...
        if (isset($_POST)) {
            ...
            if ($check_record == 1) {
                ...
                for($k=0; $k<count($this->input->post('bill_code')[$specimen_id]); $k++){

                    $bill_primary_id = $this->input->post('bill_code')[$specimen_id][$k];
    ...
    public function display_published_reports_ajax_processing()
    {
        ...
        foreach ($list as $record) {
            ...
            $show_comments .= '</div>';
            $show_comments .= '</div>';
            $edit_button = '<a href="javascript:;" class="edit-icon" style="float: none !important;"><i class="fa fa-pencil"></i></a>';
