...
//                Months Not Exists
        ...
        $this->load->view('lab/dashboard', $dashboard_reports_status);
    ...
    */
    ...
    public function updateAssigndoctor()
    {   
      
      $record_id = $this->input->post('recored_id');
      $doctor_id = $_POST['doctor_id'];

      $record_map = explode(',',$record_id);
      if(!empty($record_map)){
        foreach($record_map as $key=> $val){
          ...
          $this->db->where('uralensis_request_id', $val);
          $this->db->update("request", $assign_request_args);
        }

        $json['type'] = 'success';
        $json['msg'] = 'Doctor assigned successfully.';
    ...
    */
    ...
    public function updateAssignCourier()
    {   
      $record_id = $this->input->post('recored_id');
      ...
      if(!empty($record_id)){
        foreach($record_id as $key=> $val){
          ...
          $assign_request_courier = array(
                'emis_number' => $courier_id
              );
          $this->db->where('uralensis_request_id', $val);
          $this->db->update("request", $assign_request_courier);
        }

        $json['type'] = 'success';
        $json['msg'] = 'Courier assigned successfully.';
        echo json_encode($json);
        die;
      }else{
        $json['type'] = 'failed';
    ...
    public function lab_record_list($request_status = '')
    {
        ...
        $data["query"] = $this->Doctor_model->lab_record_list($doctor_id, $filter, $request_status);
        $data['request_slides_id'] = $this->Doctor_model->lab_record_list_with_slide($doctor_id, $filter, $request_status);
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/record_list', $data);
        $this->load->view('lab/inc/footer-new');
    }
     ...
     * @return void
     */
    public function lab_record_detail($id, $view = '')
    {
        if (!$this->ion_auth->logged_in()) {
            redirect('auth/login', 'refresh');
        }
        $this->mybreadcrumb->add('Dashboard', base_url('index.php/lab'));
        $this->mybreadcrumb->add('Record Listing', base_url('index.php/lab/lab_record_list'));
        $this->mybreadcrumb->add('Record Detail', base_url('index.php/lab/lab_record_detail'));
        ...
        require_once('application/views/lab/comment_section.php');
        require_once('application/views/lab/manage_supplementary.php');
        require_once('application/views/lab/manage_documents.php');
        require_once('application/views/lab/related_posts.php');
        require_once('application/views/lab/get_specimens.php');
        require_once('application/views/lab/special_notes.php');
        require_once('application/views/lab/inc/functions.php');
        require_once('application/views/lab/datasets/datasets.php');
        require_once('application/views/lab/record_history/record_history-functions.php');
        ...
        if ($view == 'view') {
            ...
            $this->load->view('lab/record_detail_view', $data_and_files);
            $this->load->view('lab/inc/footer-new');
        } elseif ($view == 'bridgehead') {
            $this->load->view('lab/inc/header-new');
            $this->load->view('lab/record_detail_bridgehead.php', $data_and_files);
            $this->load->view('lab/inc/footer-new');
        } else {

            $this->load->view('lab/inc/header-new');
            $this->load->view('lab/record_detail', $data_and_files);
            $this->load->view('lab/inc/footer-new');
        }
    }
    ...
    public function virology_record_list()
    {
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/record_list', $result);
        $this->load->view('lab/inc/footer-new');
    }

    public function lab_record_detail_old($id, $view = '')
    {
        if (!$this->ion_auth->logged_in()) {
            redirect('auth/login', 'refresh');
        }
...
//            echo "<pre>";print_r($slide_data['slide_data']);exit;
        ...
        require_once('application/views/lab/comment_section_old.php');
        require_once('application/views/lab/manage_supplementary_old.php');
        require_once('application/views/lab/manage_documents_old.php');
        require_once('application/views/lab/related_posts_old.php');
        require_once('application/views/lab/get_specimens_old.php');
        require_once('application/views/lab/special_notes_old.php');
        require_once('application/views/lab/inc/functions_old.php');
        require_once('application/views/lab/datasets/datasets.php');
        require_once('application/views/lab/record_history/record_history-functions_old.php');
        if ($view == 'view') {
            $this->load->view('lab/inc/header-new');
            $search_query = explode("_", $this->input->get('slide'));
            if ($search_query != null) {
            ...
            $this->load->view('lab/autopsy_edit_record', $data_and_files);
            $this->load->view('lab/inc/footer-new');
        } elseif ($view == 'virology') {
            $this->load->view('templates/header-new');
            $this->load->view('lab/virology_edit_record', $data_and_files);
            $this->load->view('lab/inc/footer-new');
        } else {
            ...
            $this->load->view('lab/inc/header-new');
            $this->load->view('lab/record_detail_old', $data_and_files);
            $this->load->view('lab/inc/footer-new', $footer_data);
        }
    }


    public function lab_record_details_new($id, $view = '')
    {
        if (!$this->ion_auth->logged_in()) {
            redirect('auth/login', 'refresh');
        }
        ...
        require_once('application/views/lab/manage_documents_old.php');
        require_once('application/views/lab/related_posts_old.php');
        require_once('application/views/lab/get_specimens_micro.php');
        require_once('application/views/lab/special_notes_old.php');
        require_once('application/views/lab/inc/functions_old.php');
        require_once('application/views/lab/datasets/datasets.php');
        require_once('application/views/lab/record_history/record_history-functions_old.php');
        if ($view == 'view') {
            ...
            $this->load->view('lab/inc/header-new');
            $this->load->view('lab/record_detail_new_temp', $data_and_files);
            $this->load->view('lab/inc/footer-new', $footer_data);
        }
    }
     ...
     * @return void
     */
    public function lab_record_detail_new($id)
    {
        if (!$this->ion_auth->logged_in()) {
            redirect('auth/login', 'refresh');
        }
        ...
        require_once('application/views/lab/related_posts.php');
        $this->load->view('lab/inc/header-new', $data_and_files);
        $this->load->view('lab/record_detail-new', $data_and_files);
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function update_report()
    {
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/update_recored');
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function publish_report()
    {
        ...
        if (isset($id) && !empty($id)) {
            ...
            redirect('lab/update_report/' . $id, 'refresh');
        }
    }
    ...
    public function additional_work()
    {
        ...
        redirect('lab/case_review_list/', 'refresh');
    }
    ...
    public function change_payment_status(){
        ...
        $this->db->update('request', array('payment_status' => $status));
    }
    ...
    public function published_reports()
    {
        ...
        $data["query"] = $this->Doctor_model->lab_record_list($doctor_id, $filter);
        $data['request_slides_id'] = $this->Doctor_model->lab_record_list_with_slide($doctor_id, $filter);
        $checkhospital = getRecords("group_id", "users_groups_type", array("user_id" => $doctor_id));
        $hospitallist = array();
        foreach ($checkhospital as $rec) 
		{
        ...
        // }
        // $this->mybreadcrumb->add('Dashboard', base_url('index.php/lab'));
        // $this->mybreadcrumb->add('Publish Reports', base_url('index.php/lab/published_reports'));
        // $breadcrumb['breadcrumbs'] = $this->mybreadcrumb->render();
        // $doctor_id = $this->ion_auth->user()->row()->id;
        // $filter = " AND request.speciality_group_id IN(1,2)";
        // $data['doctor_list'] = $this->Admin_model->get_doctors();
        // $data['query'] = $this->Doctor_model->get_all_records($doctor_id, $filter);
        // $data['request_slides_id'] = $this->Doctor_model->lab_all_record_list_with_slide($doctor_id, $filter);
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/record_latest', $data);
        $this->load->view('lab/inc/footer-new');
    }
    public function all_record(){
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/all_record_view', $data);
        $this->load->view('lab/inc/footer-new');
    }
    /**
    ...
    public function view_report($id)
    {
        ...
        if (isset($id) && !empty($id)) {
            ...
            $data5['query5'] = $this->Doctor_model->get_hospital_info($id);
            $result = array_merge($data1, $data2, $data3, $data4, $data5, $lab_release_date);
            $this->load->view('lab/viewpdf', $result);
        }
    }
    ...
    public function view_autopsy_report($id)
    {
        ...
        if (isset($id) && !empty($id)) {
            ...
            $this->load->view('lab/view_autopsy_pdf_new', $result);
        }
    }
     ...
     * @return void
     */
    public function lab_download_section($id)
    {
        if (!$this->ion_auth->logged_in()) {
            redirect('auth/login', 'refresh');
        }
        ...
        $files_data["files"] = $this->Doctor_model->fetch_files_data($id);
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/download_section', $files_data);
        $this->load->view('lab/inc/footer-new');
    }
...
//        endif;
    ...
    public function datatable_record()
    {
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/test_view', $json);
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function teaching_cases()
    {
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/teaching_cases', $edu_cats);
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function mdt_cases()
    {
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/mdt_cases', $result);
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function mdt_cases_new()
    {
        ...
        $result = array_merge($hospitals);
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/mdt_cases_new', $result);
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function publish_to_post_mdt()
    {
        ...
        if (isset($_GET)) {
            ...
            redirect('/lab/find_mdt_cases?hospital_id=' . $hospital_id);
        }
    }
    ...
    public function teaching_case_detail($record_id)
    {
        ...
        if (isset($record_id)) {
            ...
            $this->load->view('lab/inc/header-new');
            $this->load->view('lab/teaching_case_detail', $data);
            $this->load->view('lab/inc/footer-new');
        }
    }
    ...
    public function mdt_case_detail()
    {
        ...
        if (isset($_GET['record_id'])) {
            ...
            $this->load->view('lab/inc/header-new');
            $this->load->view('lab/mdt_case_detail', $mdt_case_result);
            $this->load->view('lab/inc/footer-new');
        }
    }
  ...
  public function view_further_work()
    {
        ...
        if (!empty($_GET) && $_GET['fw_page'] == 'requested') {
            ...
            $this->load->view('lab/inc/header-new');
            // $this->load->view('lab/fw_requested', $fw_data1);
            ...
            $this->load->view('lab/inc/header-new');
            $this->load->view('lab/fw_completed', $fw_data2);
            $this->load->view('lab/inc/footer-new');
        } else {
            redirect('/lab');
        }
 ...
 public function view_further_work_new()
    ...
    public function further_work_complete($fw_id)
    {
        ...
        redirect('/lab/view_furtehr_work');
    }
    ...
    public function profile_form()
    {
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/profile_form', $decryptedDetails);
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function update_profile()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('lab/inc/header-new');
            $this->load->view('lab/profile_form');
            $this->load->view('lab/inc/footer-new');
        } else {
    ...
    public function messages_center()
    {
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/message_center/message_center', $merge_msg_data);
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function view_private_msg($msg_id)
    {
        ...
        if (!empty($msg_id)) {
            ...
            $this->load->view('lab/inc/header-new');
            $this->load->view('lab/message_center/message_view', $display_msg);
            $this->load->view('lab/inc/footer-new');
        }
    }
    ...
    public function generate_word()
    {
        ...
        if (!empty($_GET['hospital_id']) && !empty($_GET['mdt_date'])) {
            ...
            $this->load->view('lab/inc/documents/word', $mdt_record);
        }
    }
    ...
    public function generate_mdt_pdf()
    {
        ...
        if (!empty($_GET['hospital_id']) && !empty($_GET['mdt_date'])) {
            ...
            $mdt_list = !empty($_GET['mdt_list']) ? $_GET['mdt_list'] : '';
            $mdt_record['mdt_records'] = $this->Doctor_model->mdt_cases_list_model($hospital_id, $mdt_date, $mdt_list);
            $this->load->view('lab/inc/documents/mdt_pdf', $mdt_record);
        }
    }
    ...
    public function case_review_list()
    {
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/display_review_cases', $data);
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function save_flag_comments()
    {
        ...
        if (!empty($_POST['flag_comment'])) {
            ...
            $json['type'] = 'success';
            $json['msg'] = 'Flag Comment Added Successfully.';
            echo json_encode($json);
            die;
        } else {
            $json['type'] = 'error';
    ...
    public function authorization_queue()
    {
        ...
        //echo last_query();
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/authorization_queue_records', $auth_queue);
        $this->load->view('lab/inc/footer-new');
    }
     ...
     * @return void
     */
    public function lab_opinion_cases()
    {
        if (!$this->ion_auth->logged_in()) {
            redirect('auth/login', 'refresh');
        }
...
//        echo "<pre>";print_r($opinion_cases['opinion_cases']);exit;
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/opinion_cases/opinion_cases_new', $opinion_cases);
        $this->load->view('lab/inc/footer-new', $footer_data);
    }
     ...
     * @return void
     */
    public function lab_opinion_requested_detail()
    {
        if (!$this->ion_auth->logged_in()) {
            redirect('auth/login', 'refresh');
        }
     ...
     * @return void
     */
    public function lab_opinion_cases_requested()
    {
        if (!$this->ion_auth->logged_in()) {
            redirect('auth/login', 'refresh');
        }
        ...
        $this->mybreadcrumb->add('Dashboard', base_url('index.php/lab'));
        $this->mybreadcrumb->add('Opinion Cases Requested', base_url('index.php/lab/doctor_opinion_cases_requested'));
        $opinion_cases['breadcrumbs'] = $this->mybreadcrumb->render();

        $opinion_cases['opinion_cases'] = $this->Doctor_model->display_opinion_cases_requested($doctor_id, $opinion_status);
        $opinion_cases['request_slides_id'] = $this->Doctor_model->doctor_record_list_with_slide($doctor_id);
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/opinion_cases/opinion_cases_requested', $opinion_cases);
        $this->load->view('lab/inc/footer-new');
    }
...
//            addNotification($notification_data);
            foreach ($_POST['opinion_case_doctors'] as $key => $value) {
                ...
                $notification_data = array(
                    ...
                    'notification' => "You have received an opinion request from <br>$first_name $last_name</br>",
                    'startdate' => date('Y-m-d'),
                    'redirect_url' => 'lab/lab_opinion_cases'
                );
                addNotification($notification_data);
                ...
                if ($this->input->post("internal_opnion_request") == "external") {
                    ...
                    $message = $this->load->view("lab/email/request_email", $sendData, TRUE);
                    $config = Array(
                        'mailtype' => 'html',
                        'charset' => 'utf-8', //iso-8859-1
                        'newline' => '\r\n',
    ...
    public function opinion_record_detail($id)
    {
        ...
        require_once('application/views/lab/get_specimens.php');
        require_once('application/views/lab/special_notes.php');
        require_once('application/views/lab/opinion_cases/get_opinion_cases.php');
        require_once('application/views/lab/inc/functions.php');
        require_once('application/views/lab/datasets/datasets.php');
        require_once('application/views/lab/record_history/record_history-functions.php');
        $this->load->view('lab/inc/header-new');
...
//                echo $this->db->last_query();exit;
                if ($opinion_update) {
                    $this->session->set_flashdata('record_status', 'Opinion status updated successfully');
                    redirect('lab/lab_opinion_cases');
                } else {
                    $this->session->set_flashdata('record_status', 'Something went wrong');
                    redirect('lab/lab_opinion_cases');
                }
    ...
    public function display_invoices()
    {
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/invoices/display_invoices', $invoice_data);
        $this->load->view('lab/inc/footer-new');
    }
...
//            $this->db->update("opinion_comment_likes",$dataArray);
    ...
    public function record_tracking()
    {
        ...
        if ($doc_permissions === 'on') {
            ...
            $this->load->view('lab/record_tracking/index', $track_set_data);
        }
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function view_session_records()
    {
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/record_tracking/view_session_records');
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function print_session_records_document($sess_record_id)
    {
        ...
        $this->load->view('lab/record_tracking/sessions_record_pdf', $session_rec_data);
    }
    ...
    public function generateBulkReports()
    {
        ...
        if (!empty($_GET['id'])) {
            ...
            $this->load->view('lab/generate_bulk_report', $records_ids);
        }
    }
...
//        redirect('/doctor/doctor_record_detail/' . $specimen_request_id);
        redirect('/lab/doctor_record_detail_old/' . $specimen_request_id);
    }
    ...
    public function showSnomedCodes()
    {
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/snomed_codes');
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function editSnomedCode($snomed_id, $snomed_type)
    {
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/edit_snomed_code', $query);
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function deleteSnomedCode($snomed_id, $snomed_type)
    {
        ...
        redirect('lab/showSnomedCodes', 'refresh');
    }
    ...
    public function showMicroscopicCodes()
    {
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/show_microscopic_codes', $micro_code);
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function editMicroCode($micro_id = '')
    {
        ...
        $this->load->view('lab/inc/header-new');
        $this->load->view('lab/edit_microscopic_code', $query);
        $this->load->view('lab/inc/footer-new');
    }
    ...
    public function search_record()
    {
        ...
        if (!empty($_GET['hospital_id']) && !empty($_GET['doctors_ids']) && !empty($_GET['selected_year'])) {
            ...
            $this->load->view('lab/inc/header-new');
            $this->load->view('lab/search_other_doctor_records', $doctor_records);
            $this->load->view('lab/inc/footer-new');
        }
    }
    ...
    public function record_dataset($record_id = '')
    {
        ...
        if (!empty($record_id)) {
            $this->load->view('lab/inc/header-new');
            $this->load->view('lab/datasets/indexv2');
            $this->load->view('lab/inc/footer-new');
        }
    }
    ...
    public function printPDFDatasetData($dataset_id)
    {
        ...
        $this->load->view('lab/datasets/datasets_pdf', $result);
    }

    public function support()
    {
        $title = "Support";
        $data = array('home_url' => '/lab');
        $this->load->view('lab/inc/header-new');
    ...
    public function histo_record_edit($id, $view = '')
    {
        ...
        if ($view == 'view') {
            ...
            $this->load->view('lab/inc/header-new');
            $this->load->view('lab/histo_record_edit', $data_and_files);
            $this->load->view('lab/inc/footer-new');
        }
    }
...
//                 Send email and attach uploaded images to email
    ...
    public function update_autopsy_record($record_id)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('templates/header-new');
            $this->load->view('lab/update_autopsy_record', $data);
...
//                $createHtml .= "</tr>";
    ...
    public function add_further_work($id)
    {
        ...
        $this->mybreadcrumb->add('Dashboard', base_url('index.php/doctor'));
        $this->mybreadcrumb->add('Record Listing', base_url('index.php/institute/doctor_record_list'));
        $this->mybreadcrumb->add('Record Detail', base_url('index.php/institute/doctor_record_detail'));
        if (isset($id) && !empty($id)) {
            $data['javascripts'] = [
...
//                     Check if doctor is assigned request
            ...
            $this->load->view('lab/further_work', $result);
            $this->load->view('lab/inc/footer-new');
        }
    }
...
//            exit; 
            $this->load->view('templates/header-new');
            $this->load->view('lab/further_work_new', $data);
            $this->load->view('templates/footer-new');
        }
    }
    ...
    public function view()
    {
        ...
        $this->load->view('templates/header-new');
        $this->load->view('lab/lab_view', $result);
        $this->load->view('templates/footer-new');
    }
...
//        echo "<pre>";print_r($datasets_cases['datasets_case_types']);exit;
    ...
    public function record_cases()
    {
        ...
        $this->mybreadcrumb->add('Dashboard', base_url('index.php/lab'));
        $this->mybreadcrumb->add('Record Cases', base_url('index.php/lab/datasets_cases'));
        $datasets_cases['breadcrumbs'] = $this->mybreadcrumb->render();
...
//                    echo $week." = ".$start_date." - ".$datetime1->format('Y-m-d')."<br/>";
    ...
    public function datasets_list()
    {
        ...
        $this->mybreadcrumb->add('Dashboard', base_url('index.php/lab'));
        $this->mybreadcrumb->add('Dataset List', base_url('index.php/lab/datasets_list'));
        $datasets_cases['breadcrumbs'] = $this->mybreadcrumb->render();
...
public function updatePatientsRecord()
	...
	public function delete_record($record_id)
    {
		...
		redirect('lab/lab_record_list', 'refresh');
    }
	
	public function delete_record_all()
    {/*
        $current_date_year = date('Y');
...
$this->db->query("DELETE FROM users_request WHERE request_id IN ($record_id)");
$this->db->query("DELETE FROM request_specimen WHERE rs_request_id IN ($record_id)");
$this->db->query("DELETE FROM request_assignee WHERE request_id IN ($record_id)");
$this->db->query("DELETE FROM further_work WHERE request_id IN ($record_id)");
$this->db->query("DELETE FROM specimen WHERE request_id IN ($record_id)");
$this->db->query("DELETE FROM request WHERE uralensis_request_id IN ($record_id)");
$this->db->query("DELETE FROM additional_work WHERE request_id IN ($record_id)");
$this->db->query("DELETE FROM files WHERE files.record_id IN ($record_id)");
$this->db->query("DELETE FROM additional_work WHERE additional_work.request_id IN ($record_id)");
$this->db->query("DELETE FROM uralensis_sec_rec_assign WHERE uralensis_sec_rec_assign.ura_sec_rec_rec_id IN ($record_id)");
$this->db->query("DELETE FROM uralensis_record_track_status WHERE uralensis_record_track_status.ura_rec_track_record_id IN ($record_id)");
$record_del_status = '<p class="bg-success" style="padding:7px;">Record Has Been Successfully Deleted.</p>';
$this->session->set_flashdata('record_status', $record_del_status);
redirect('lab/lab_record_list', 'refresh');
    */}
