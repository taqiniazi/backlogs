        ...
        foreach ($list as $record) {
            ...
            if (!empty($record->record_batch_id)) {
             ...
             if(empty($record->medicare_card_no)) {
				...
				{
                $medicare_card_no = '<form action="generate_orm_file" method="post"><input value="10
				" type="hidden" name="'.$record->patient_id.'"><input value="10
				" type="hidden" name="'.$record->request_id.'"><input name="sub" type="submit" value="Report"><input type="submit" name="sub2" value="Bill"></form>';
				}
				else
				{
					$medicare_card_no ="";
