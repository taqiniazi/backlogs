...
//            pre("<hr><hr><hr>", false);
    ...
    private function getPID($row){
        return [
            ...
            'Phone Number Home'                 => $this->convertContactInfo(trim($row[13])),
    ...
    private function addPatientData($pArr){
        if(!empty($pArr['Patient Name']['First Name'])){
            $patientArr = [
                ...
                'phone'         => setValue($pArr['Phone Number Home']['Phone Number']),
                'town'          => setValue($pArr['Phone Number Home']['Area City Code']),
