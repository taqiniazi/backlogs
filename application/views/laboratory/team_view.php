    ...
    <?php
        ...
        <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
            <div class="profile-widget">
                ...
                <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="<?= base_url();?>laboratory/edit_user/<?php print $resValue["id"];?>"><?= $resValue["first_name"].' '.$resValue["last_name"];?></a></h4>
                        ...
                        <tr>                            
                            ...
                            <td class='text-center'>
                                <?php if($resValue['wrong_attempt'] >= 3) { ?>
                                    <button type="button" class="btn btn-danger status-btn" data-id="<?= $resValue['id']; ?>" data-email="<?= $resValue['email']; ?>">Unblock</button>
                                <?php } else { ?>
