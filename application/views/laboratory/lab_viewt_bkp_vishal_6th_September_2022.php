    ...
    <div class="row staff-grid-row">
            ...
            <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                <div class="profile-widget">
                    <div class="profile-img">
                        <a href="<?php echo base_url();?>laboratory/edit_lab/<?php echo base64_encode($resValue["lab_id"]);?>" class="avatar"><img src="<?= base_url() ?>uploads/logo/<?= $resValue['logo']; ?>" alt=""><?php echo $resValue["first_initial"];?><?php echo $resValue["last_initial"];?></a>
                    </div>
                    <?php if($is_admin) { ?>
                    <div class="dropdown profile-action">
                        <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="<?php echo base_url();?>laboratory/edit_lab/<?php echo base64_encode($resValue["lab_id"]);?>" ><i class="fa fa-pencil m-r-5"></i> Edit</a>
                    ...
                    <?php } ?>
                    <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="<?php echo base_url();?>auth/edit_group/<?php echo $resValue["id"];?>"><?php echo $resValue["description"];?></a></h4>
        ...
        <?php $cnt =0; foreach($hospital_info as $resKey => $resValue) {  $cnt ++; ?>
            <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                <div class="profile-widget">
                    <div class="profile-img">
                        <a href="<?php echo base_url();?>laboratory/edit_clinic/<?php echo base64_encode($resValue["hosp_id"]);?>" class="avatar"><img src="<?= base_url() ?>uploads/logo/<?= $resValue['logo']; ?>" alt=""><?php echo $resValue["first_initial"];?><?php echo $resValue["last_initial"];?></a>
                    </div>
                    <?php if($is_admin) { ?>
                        <div class="dropdown profile-action">
                            <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                    ...
                    <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="<?php echo base_url();?>auth/edit_group/<?php echo $resValue["id"];?>"><?php echo $resValue["description"];?></a></h4>
                    <div class="small text-muted"><?php echo $resValue["lab_city"];?></div> 
                    <div class="col-md-12"><img src="<?php echo base_url()?>assets/icons/publishBlack.png" class="mr-2" width="20px"> Patients: <strong ><?= $resValue['patient_count']; ?></strong></div>
                    <div class="col-md-12"><img src="<?php echo base_url()?>assets/icons/UnPublishBlack.png" class="mr-2" width="20px"> Requests: <strong><?= $resValue['request_count']; ?></strong></div>
                    <div class="col-md-12"><a href="javascript:br_template_modal('<?php echo $resValue["hospital_id"];?>');"><i class='fa fa-barcode mr-2'></i>Barcode Template </a></div>
                </div>
            </div>
        <?php } ?>
    </div>
