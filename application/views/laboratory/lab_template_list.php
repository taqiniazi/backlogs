...
<link rel="stylesheet" href="<?= base_url(); ?>assets/newtheme/css/style.css">
...
<div class="modal custom-modal" id="confirm_modal" tabindex="-1" role="dialog">
          ...
          <div class="modal-content">
              <div class="modal-body">
                  ...
                  <div class="modal-btn delete-action">
                      <div class="row">
                          <div class="col-sm-6">
                              <a href="" class="btn btn-primary continue-btn record-delete-btn" id='dl_record'>Delete</a>
                          </div>
                          <div class="col-sm-6">
                              <a href="javascript:void(0);" data-dismiss="modal" onclick="$('#confirm_modal').css('display', 'none')" class="btn btn-primary cancel-btn">Cancel</a>
                          </div>
                      </div>
                  </div>
              </div>
            ...
            if (!empty($lab_templates)) {
                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <a class="dropdown-item" href="javascript:confirm_delete(<?= $row->id ?>)" ><i class="fa fa-trash m-r-5"></i> </a>
                    </td>
                    </td>
                </tr>
...
<script type="text/javascript">
    function confirm_delete(rec_id){            
        $("#confirm_modal").css('display', 'block');
        $('#confirm_modal').modal('show');
        var url = "<?php echo base_url('laboratory/delete_lab_template/'); ?>"+rec_id;
        $('#dl_record').attr('href', url);
     }              
