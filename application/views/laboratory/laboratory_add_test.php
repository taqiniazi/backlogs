...
#laboratory-test-table_wrapper div.row:nth-child(2) .col-sm-12{
    padding-right: 0;
}
#laboratory-test-table_filter{margin-right: 15px;}
.submit{padding: 5px 10px; float: right;top: 10px;
    position: relative;}
.modal-body .form-group{margin-bottom: 0;}
</style>
<div class="content container-fluid publish-record">
    <div class="record_publish_listing">
        <div class="col-xs-12 col-sm-4 form-group" style="padding-left: 0;">
        ...
        <div class="col-sm-8 form-group" style="padding-right: 0;">
            <a href="javascript:void(0);" class="btn add-btn" data-toggle="modal" data-target="#upload_test_modal" style="background: #55ce63; display:none"><i class="glyphicon glyphicon-upload"></i> Upload</a>
            <a href="javascript:void(0);" class="btn add-btn mr-2" id="show_upload_div"><i class="fa fa-upload"></i> Import CSV</a>
            <a href="javascript:void(0);" class="btn add-btn mr-2" data-toggle="modal" data-target="#add-laboratory-test-modal"><i class="glyphicon glyphicon-plus-sign"></i> Add Test</a>
            <a href="javascript:void(0);" class="btn add-btn mr-2" data-toggle="modal" data-target="#add-lab-test-sub-category-modal"><i class="glyphicon glyphicon-plus-sign"></i> Add test sub categories</a>
            <a href="javascript:void(0);" class="btn add-btn mr-2" data-toggle="modal" data-target="#add-lab-test-category-modal"><i class="glyphicon glyphicon-plus-sign"></i> Add test categories</a>
        </div>
        <div class="clearfix"></div>

        <div class="col-sm-12" style="margin-bottom: 10px; display:none; padding-left: 0;" id="upload_csv">
            <form method="POST" action="<?= base_url('laboratory/addTestDataFromCsv'); ?>" enctype="multipart/form-data" name="impForm" id="ImpForm">
                <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
                <div class="modal-body" style="padding: 15px!important; background-color:#fff;">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-4" style="text-align: center;">
                            <div class="form-group">
                                <a href="https://pci.pathhub.uk/uploads/LabTests.csv" style="position: relative;
    top: 13px; "><i class="fa fa-download"></i> Download Sample File</a>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4">
                            <div class="form-group">
                                <button class="btn btn-info btn-rounded btn-lg submit">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <table id="laboratory-test-table" class="table table-striped custom-table"
                    ...
                    <tr>
                        <th>
                            ...
                            <a href="javascript:;" class="generate-bulk-reports" data-bulkurl="<?= base_url('index.php/doctor/generateBulkReports'); ?>">
...
<!--                                <i class="fa fa-download"></i>-->
            ...
            <div class="row">
            <div class="col-sm-12 button-delete form-group" style="text-align:end; padding-right: 35px; padding-top: 10px;">
                <button class="btn-danger text-end selected_delete" style="background: #03c5fb; border: 1px solid #03c5fb; "><i class="glyphicon glyphicon-trash"></i> Delete </button>
            </div>
            </div>
        </div>
        </div>
...
<div id="add-lab-test-category-modal" class="modal custom-modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12" id="department_id_container">
                        <div class="form-group">
                            <label class="col-form-label">Department</label>
                            <select name="department_id" id="department_id" class="department_id select2 form-control" data-rule-required='true'>

                            </select>
                        </div>
                    </div>
                    <div class="col-md-12" id="specialty_id_container">
                        <div class="form-group">
                            <label class="col-form-label">Specialty</label>
                            <select name="specialty_id" id="specialty_id" class="specialty_id select2 form-control" data-rule-required='true'>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input name="category" id="test-category-add-name" class="form-control" placeholder="Enter testcategory name" />
...
<div id="add-lab-test-sub-category-modal" class="modal custom-modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Test Sub Category</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12" id="department_id_container">
                        <div class="form-group">
                            <label class="col-form-label">Department</label>
                            <select name="department_id" id="" class="department_id select2 form-control" data-rule-required='true'>
                    ...
                    <div class="col-md-12" id="specialty_id_container">
                        <div class="form-group">
                            <label class="col-form-label">Specialty</label>
                            <select name="specialty_id" id="" class="specialty_id select2 form-control" data-rule-required='true'>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="col-form-label">Category</label>
                            <select name="category" id="main_category_id" class="select2 form-control" data-rule-required='true'>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input name="sub_category" id="test-sub-category-add-name" class="form-control" placeholder="Enter testcategory name" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group" style="margin-bottom: 10px;">
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <input type="hidden" id="lab_id" name="lab_id" value="128">
                                        <input type="hidden" id="groupId" name="groupId" value="<?php echo $lab['id']; ?>" />
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12" id="department_id_container" style="display: block;">
                                <div class="form-group">
                                    <label class="col-form-label">Department</label>
                                    <select name="department_id" id="" class="department_id select2" data-rule-required='true'>

                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12" id="specialty_id_container" style="display: block            ;">
                                <div class="form-group">
                                    <label class="col-form-label">Specialty</label>
                                    <select name="specialty_id" id="specialty_id" class="specialty_id select2">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12" id="dv_sub_categories" style="display:none">
                            <div class="form-group">
                                ...
                                <select name="test_sub_category_main" id="test_sub_category_main" class="select2">
...
<div id="edit_lab_test_modal" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <?php  echo form_open(base_url('laboratory/edit_test'), ['id' => 'edit_laboratory_test_form']) ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group" style="margin-bottom: 10px;">
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <input type="hidden" id="lab_id" name="lab_id" value="128">
                                        <input type="hidden" id="groupId" name="groupId" value="128" />
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12" id="edit_department_id_container" style="display: none;">
                                <div class="form-group">
                                    <label class="col-form-label">Department</label>
                                    <select name="department_id" id="edit_department_id" class="select2" data-rule-required='true'>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12" id="edit_dv_sub_categories" style="display:none">
                            <div class="form-group">
                                <label class="col-form-label">Sub Categories:</label>
                                <select name="test_sub_category_main" id="edit_test_sub_category_main" class="select2" >
                                    <?php foreach ($testSubCategories as $subKey => $subValue) { ?>
                                        <option value="<?php echo $mainValue["id"]; ?>"><?php echo $subValue["name"]; ?></option>
                                    <?php } ?>
                                </select>
...
<div class="modal custom-modal fade" id="delete_lab_modal" role="dialog">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="modal-btn delete-action">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="javascript:void(0);" class="btn btn-primary continue-btn lab-delete-btn" style="background-color:#fff !important;" onMouseOver="this.style.color='#fff'; this.style.background='#00c5fb'" onMouseOut="this.style.color='#00c5fb'; this.style.background='#fff'">Delete</a>
                        </div>
                        <div class="col-md-6">
                            <a href="javascript:void(0);" data-dismiss="modal"
                                class="btn btn-primary cancel-btn" style="background-color:#fff !important;" onMouseOver="this.style.color='#fff'; this.style.background='#00c5fb'" onMouseOut="this.style.color='#00c5fb'; this.style.background='#fff'">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
