...
<div class="container-fluid lab-heading top-boxed">
			...
			<div class="col-sm-4">
				<div class="pull-right">
                    ...
                    <?php if($is_hospital_admin) { ?>                    
                        <a style="margin-right: 10px; margin-bottom:10px;" href="<?php echo base_url('laboratory/create_user'); ?>" class="btn add-btn"><i class="fa fa-plus"></i> User</a>  &nbsp;&nbsp;                  
                    <?php } ?>
	...
	<div class="clearfix"></div>
	<div class="row lab-dashborad">
         <div class="col-md-6 col-sm-6 col-lg-3 col-xl-3">
         <a href="javascript:;">
            <div class="card dash-widge">
                <div class="card-body">
					...
					<div class="tab-content" style="padding: 20px;">
                        <div class="tab-pane active" id="booking_in">
							<ul class="histo_lab_staus list-unstyled">
								<li>
									<a href="javascript:;" class="numbers"><span><?php echo $labEntry; ?></span> Lab Entry</a>
								</li>
								<li>
									<a href="javascript:;" class="numbers"><span><?php echo $specimenLabeling; ?></span> Specimen Labelling </a>
								</li>
								<li>
									<a href="javascript:;" class="numbers"><span><?php echo $cutUp; ?></span> Cut up/Grossing</a>
								</li>
								<li>
									<a href="javascript:;" class="numbers"><span><?php echo $embedding; ?></span> Embedding & Microtomy</a>
								</li>
								<li>
									<a href="javascript:;" class="numbers"><span><?php echo $staining; ?></span> Staining</a>
								</li>
								<li>
									<a href="javascript:;" class="numbers"><span><?php echo $quality; ?></span> Quality Assurance</a>
								</li>
								<li>
									<a href="javascript:;" class="numbers"><span><?php echo $slideScanner; ?></span> Slide Scanner</a>
								</li>
                                <li>
									<a href="javascript:;" class="numbers"><span><?php echo $reporting; ?></span> Reporting</a>
								</li>
                                <li>
									<a href="javascript:;" class="numbers"><span><?php echo $furtherWork; ?></span> Further Work</a>
								</li>
							</ul>
						</div>
