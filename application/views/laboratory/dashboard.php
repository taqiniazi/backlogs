...
<div class="container-fluid lab-heading top-boxed">
	...
	<div class="row">
         ...
         <a href="<?php echo base_url('laboratory/network'); ?>">
                ...
                <div class="card-body">
                   ...
                   <span class="dash-widget-icon">
                    ...
                    <div class="dash-widget-info">
                        <h3>HL7<?php //echo $hospital_networks[0]["_CNT"];?></h3>
                        <span>E-Request</span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6 col-sm-6 col-lg-3 col-xl-3">
        <a href="<?php echo base_url('laboratory/Labview/H'); ?>" target="_blank">
            <div class="card dash-widget">
                <div class="card-body">
        ...
        <div class="col-md-6 col-sm-6 col-lg-3 col-xl-3">
        <a href="<?php echo base_url('laboratory/Labview/L'); ?>" target="_blank">
            <div class="card dash-widget">
                <div class="card-body">
                    <span class="dash-widget-icon">
        ...
        <div class="col-md-6 col-sm-6 col-lg-3 col-xl-3">
        <a href="<?php echo base_url('laboratory/team_view'); ?>" target="_blank">
            <div class="card dash-widget">
                <div class="card-body">
                <span class="dash-widget-icon">
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body dash_tabs nopadding">
                    ...
                    <?php
                    $labEntry = $specimenLabeling = $cutUp = $embedding = $microtomy = $staining = $quality = $slideScanner = $reporting = $furtherWork = 0; 
                    if(count($status_count) > 0){
                        foreach($status_count as $key => $status){
                            ...
                            if($status->request_code_status == 'Embedding') $embedding = $status->request_status_count;
							if($status->request_code_status == 'Microtomy') $microtomy = $status->request_status_count;
					...
					<div class="tab-content" style="padding: 20px;">
                        ...
                        <ul class="histo_lab_staus list-unstyled">
								...
								<li>
									<a href="<?php echo base_url()."index.php/lab/lab_record_list/".base64_encode('Embedding') ?>" class="numbers"><span><?php echo $embedding; ?></span> Embedding</a>
								</li>
                                <li>
									<a href="<?php echo base_url()."index.php/lab/lab_record_list/".base64_encode('Microtomy') ?>" class="numbers"><span><?php echo $microtomy; ?></span> Microtomy</a>
								</li>
								<li>
		...
		<div class="col-md-4 d-flex">
			<div class="card flex-fill">
				<div class="card-body"  style="min-height: 400px;">
					...
					<div>
						<p><i class="fa fa-dot-circle-o text-success mr-2"></i>Total Tasks <span class="float-right"><?= $today_request; ?></span></p>
						<p><i class="fa fa-dot-circle-o text-purple mr-2"></i>Completed Tasks <span class="float-right"><?= $task_count; ?></span></p>
						<p><i class="fa fa-dot-circle-o text-danger mr-2"></i>Pending Tasks <span class="float-right"><?= $today_request - $task_count; ?></span></p>
					</div>
				</div>
			</div>
		</div>
