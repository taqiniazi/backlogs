        ...
        <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
            <div class="profile-widget">
                <div class="profile-img">
                    <a href="<?php echo base_url();?>auth/edit_group/<?= $resValue["user_id"];?>" class="avatar"><img src="assets/img/profiles/avatar-02.jpg" alt=""><?= $resValue["first_initial"] . $resValue["last_initial"];?></a>
                </div>
