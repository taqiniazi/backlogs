                        ...
                        <div class="card-body">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group tg-inputwithicon">
                                            <label id="roleWrap">Group</label>
                                            <select class="form-control" name="clinic_id" id="clinic_id">
                                                <option value="">Select Group</option>
                                                <?php foreach ($clinicArr as $clinic) { ?>
                                                    <option value="<?= $clinic->id; ?>" <?php echo ($cgroup_id && $cgroup_id != '' && $cgroup_id == $clinic->id) ? "selected" : ""; ?>><?= $clinic->description; ?></option>
                                                <?php } ?>
                                                <option value="128">FNQH Pathology LAB</option>
                                            </select>
