                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group tg-inputwithicon">
                                            ...
                                            <?php echo form_input(array('type' => 'text', 'name' => '', 'id' => 'email', 'value' => ((isset($user_details['user_role_name'])) ? $user_details['user_role_name'] : ''), 'class' => 'form-control', 'disabled'=> true)); ?>
