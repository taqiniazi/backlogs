...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="header">
            ...
            <!-- Header Menu 
            <ul class="list-inline pull-left ml-5"> 
            ...
            <ul class="nav user-menu">
                ...
                <?php if (in_array($group_type,LAB_GROUP)) : ?>
                    ...
                    <li class="new-item" title='Pushlied'><?php $date_year = date('Y'); ?>
                    ...
                    <li class="new-item"  title='Unpublished'>
                ...
                <?php endif; ?>
                 <?php if ($group_type=="D") : ?>
                    ...
                    <a href="<?php echo base_url('index.php/lab/published_reports/' . $date_year . '/all'); ?>"
                       class="nav-link">
                        <img src="<?php echo base_url() ?>/assets/icons/white/publish.png" class="img-responsive"/>
                        <span class="badge badge-pill">
                            <?php
                ...
                <li class="new-item hidden">
                    <a href="<?php echo base_url('index.php/lab/view_further_work?fw_page=requested'); ?>"
                       class="nav-link">
