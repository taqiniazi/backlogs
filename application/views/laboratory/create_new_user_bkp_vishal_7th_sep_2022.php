        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
            <div class="tg-dashboardbox">
                ...
                <div class="tg-editformholder">
                    ...
                    <?php echo form_open_multipart("laboratory/create_user", array('class' => 'tg-formtheme tg-editform create_user_form','id' => 'create_user_form')); ?>
                        ...
                        <div class="card-body">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group tg-inputwithicon">
                                    ...
                                    <label>Email</label>
                                    <?php echo form_input(array('type' => 'text', 'name' => 'email', 'id' => 'email', 'value' => '', 'class' => 'form-control check_email2', 'placeholder' => 'Email')); ?>
