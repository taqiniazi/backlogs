...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            <label>Raised By <em class='text-danger'>*</em></label>
            <input class="form-control" type="text" name='product' required value='<?php echo $ticketData['ticket_data'][0]['ticket_type']; ?>'>
        </div>
    </div>
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input class="form-control" type="text" name='location' required value='<?php echo $ticketData['ticket_data'][0]['location']; ?>'>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <select name="assignee[]" id="edit-assignee" class="form-control" multiple="multiple">
                    <option value="">--Select User--</option>
                    <?php
                    foreach ($userList as $value) { ?>
                        <option value="<?php echo $value['id'] ?>" <?= (in_array($value['id'], $ticketAssignee) ? 'selected' : '') ?>><?php echo $value['first_name'] . ' ' . $value['last_name'] ?></option>
                    <?php
                    } ?>
                </select>
            </div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <input class="form-control" type="text" name='ticket_subject' value='<?php echo $ticketData['ticket_data'][0]['ticket_subject']; ?>' />
        </div>
    </div>
</div>
    ...
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <select name="ticket_action" class="form-control action_taken">
                <option value="Yes" <?= ($ticketData['ticket_data'][0]['ticket_action'] == 'Yes' ? 'selected' : '') ?>>Yes</option>
                <option value="No" <?= ($ticketData['ticket_data'][0]['ticket_action'] == 'No' ? 'selected' : '') ?>>No</option>
            </select>
...
<?php 
if($ticketData['ticket_data'][0]['ticket_action'] == 'No') $hide = 'style=display:none;';
else $hide='';
?>
