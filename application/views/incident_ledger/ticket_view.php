                    ...
                    <div class="navbar">
                        <div class="float-left ticket-view-details">
                            <div class="ticket-header">
                                ...
                                <span class="m-l-15">Priority: </span>
                                <?php switch ($ticketData['ticket_data'][0]['ticket_priority']) {
                                    case 'normal':
                                        ?> <span class="badge badge-success" data-toggle="dropdown">Normal </span><?php
                                        break;
                                    case 'high':
                                        ?> <span class="badge badge-danger" data-toggle="dropdown">High </span><?php
                                        break;
                                    case 'critical':
                                        ?> <span class="badge badge-danger" data-toggle="dropdown">Critical </span><?php
                                        break;
                                } ?>
                                <span class="m-l-15">Assigned Staff: </span>
                                <?php
                                                            ...
                                                            <div class="col-md-3 col-sm-6">
                                                                <div class="uploaded-box">
                                                                    <div class="uploaded-img">
                                                                        <img src="<?php echo base_url('/uploads/lab_enquiries/' . $attachment['attachment_path']); ?>"
                                                                             class="img-fluid" alt="">
                                                                    </div>
                                                                    <div class="uploaded-img-name">
                                                                        <a href='<?php echo base_url('/uploads/lab_enquiries/' . $attachment['attachment_path']); ?>'
                                                                           target='_blank'>
                                                                ...
                                                                <div class="files-cont">
                                                                    <div class="file-type">
                                                                        <span class="files-icon"><i
                                                                                    class="fa <?php echo ($ext == 'pdf') ? "fa-file-pdf-o" : "fa-file-text-o"; ?>"></i></span>
                                                                    </div>
                                                                    <div class="files-info">
                                                                        <span class="file-name text-ellipsis"><a
                                                                                    href="<?php echo base_url('/uploads/lab_enquiries/' . $attachment['attachment_path']); ?>"
                                                                                    target='_blank'><?php echo $attachment['attachment_name']; ?></a></span>
                                                                        <span class="file-author"><span
                                                                                    class="file-date"><?php echo date("d M Y h:i A", $attachment['attachment_added_on']) . " " . timeagoCustom($attachment['attachment_added_on']); ?></span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                        <?php endif; ?>
                ...
                <div class="fixed-header">
                    <?php if ($this->ion_auth->is_admin()): ?>
                        <div class="navbar">
                            ...
                            <a href="#" class="followers-add pull-right" title="Add Assignee" data-toggle="modal"
                               data-target="#assignee"><i class="material-icons">add</i></a>
                        </div>
                    <?php endif; ?>
                    <div class="navbar">
                        <div class="task-assign">
                                                        ...
                                                        <div class="chat-content">
                                                                <span class="task-chat-user">
                                                                    <?php if (($this->ion_auth->user()->row()->id == $comment['ticket_comment_addedBy'])) {
                                                                        echo "You";
                                                                        echo "<a href='" . site_url('Incident_Ledger/deleteComment/' . $comment['ticket_comment_id'] . "/" . $comment['comment_ticket_id']) . "' class='pull-right text-danger'><i class='fa fa-times'></i> </a>";
                                                                    } else {
                    ...
                    <div class="message-bar">
                        <div class="message-inner">
                            <div class="message-area">
                                ...
                                echo form_open("Incident_Ledger/addComment/", $attributes);
                                ?>
                                <div class="input-group">
                                    <input type='hidden' name="ticketID" value='<?php echo $ticketID; ?>'/>
                                    <textarea class="form-control" placeholder="Type message..." name='commentText'
                                              required></textarea>
                                    <span class="input-group-append">
                                                <button class="btn btn-primary" type="butsubmitton"><i
