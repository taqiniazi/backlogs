...
<div class="page-header">
    <div class="row align-items-center">
        ...
        <div class="col-auto float-right ml-auto">
            ...
            <div>
                <a href="<?= site_url('/Document_List/add_improvment_corrective_action_register'); ?>" class="btn add-btn btn-rounded m-1"><i class="fa fa-plus"></i>Nonconformity Form </a>
        ...
        <div class="card-group m-b-30 enquireCaed">
            <div class="card ">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
                        <div>
                            <span class="d-block">Reopened Incident</span>
                        </div>
                        <div>
                            <span class="text-success"><?php $centage = number_format(($ticketsCountData['re_open'] / $ticketsCountData['total']) * 100, 2);
                                                        echo ($centage == "nan" ? 0 : $centage); ?>%</span>
                        </div>
                    </div>
                    <h3 class="mb-3"><?php echo $ticketsCountData['re_open']; ?></h3>
                    <div class="progress mb-2" style="height: 5px;">
                        <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo $centage; ?>%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="<?php echo $ticketsCountData['total']; ?>"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
                        <div>
                            <span class="d-block">In Progress Incident</span>
                        </div>
                        <div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
                        <div>
                            <span class="d-block">Closed - No Further Action</span>
                        </div>
                        <div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
                        <div>
                            <span class="d-block">Closed - Observation Raised</span>
                        </div>
                        <div>
                            <span class="text-success"><?php $centage = number_format(($ticketsCountData['hold'] / $ticketsCountData['total']) * 100, 2);
                                                        echo ($centage == "nan" ? 0 : $centage); ?>%</span>
                        </div>
                    </div>
                    <h3 class="mb-3"><?php echo $ticketsCountData['hold'] ?></h3>
                    <div class="progress mb-2" style="height: 5px;">
                        <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo $centage; ?>%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="<?php echo $ticketsCountData['total']; ?>"></div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
                        <div>
                            <span class="d-block">Closed - NC Raised</span>
                        </div>
                        <div>
                            <span class="text-success"><?php $centage = number_format(($ticketsCountData['cancelled'] / $ticketsCountData['total']) * 100, 2);
                                                        echo ($centage == "nan" ? 0 : $centage); ?>%</span>
                        </div>
                    </div>
                    <h3 class="mb-3"><?php echo $ticketsCountData['cancelled'] ?></h3>
                    <div class="progress mb-2" style="height: 5px;">
                        <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo $centage; ?>%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="<?php echo $ticketsCountData['total']; ?>"></div>
                    </div>
                </div>
...
<!-- Search Filter -->
<form action="<?php echo site_url('Incident_Ledger/'); ?>" method="GET" accept-charset="utf-8" class="form-group">
    <div class="row filter-row form-group">
        <div class="col-sm col">
            <div class="form-group form-focuss select-focus">
                ...
                <select class="select floating" name='status'>
                    ...
                    <option <?php echo (isset($_REQUEST['status']) && $_REQUEST['status'] == 'Reopened') ? "selected" : ""; ?> value='Reopened'> Reopened
                    </option>
                    <option <?php echo (isset($_REQUEST['status']) && $_REQUEST['status'] == 'in_progress') ? "selected" : ""; ?> value='in_progress'> In Progress
                    </option>
                    <option <?php echo (isset($_REQUEST['status']) && $_REQUEST['status'] == 'closed') ? "selected" : ""; ?> value='closed'> Closed - No Further Action
                    </option>
                    <option <?php echo (isset($_REQUEST['status']) && $_REQUEST['status'] == 'hold') ? "selected" : ""; ?> value='hold'> Closed - Observation Raised
                    </option>
                    <option <?php echo (isset($_REQUEST['status']) && $_REQUEST['status'] == 'cancelled') ? "selected" : ""; ?> value='cancelled'> Closed - NC Raised
                    </option>
                </select>
            </div>
        </div>
        <div class="col-sm col">
            <div class="form-group form-focus">
                ...
                <input class="form-control datepicker range2Picker" type="text" placeholder="Date Range..." name="start_end_date" id="start_end_date" value="<?php echo $_REQUEST['start_end_date']; ?>" readonly />
        ...
        <div class="col-sm col">
            <!-- <div class="form-group form-focuss select-focus">
                ...
                <select class="select floating" name='priority'>
                    ...
                    <option <?php echo (isset($_REQUEST['priority']) && $_REQUEST['priority'] == 'critical') ? "selected" : ""; ?> value='critical'> Critical
                    </option>
                    <option <?php echo (isset($_REQUEST['priority']) && $_REQUEST['priority'] == 'high') ? "selected" : ""; ?> value='high'> High
                    </option>
                    <option <?php echo (isset($_REQUEST['priority']) && $_REQUEST['priority'] == 'normal') ? "selected" : ""; ?> value='normal'> Normal
                    </option>
                </select>
            </div> -->
        </div>
            ...
            <div class="card-body dash_tabs nopadding">
                ...
                <div class="tab-content" style="padding: 20px;">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped custom-table mb-0" id="admin_users_activities">
                                    ...
                                    <tbody>
                                        <?php
                                        $count = 1;
                                        // print_r($ticketsData); die;
                                        foreach ($ticketsData as $result) : ?>
                                            <tr>
                                                <td><?php echo $count;
                                                    $count++; ?></td>
                                                <td>
                                                    <a href="<?php echo site_url('Incident_Ledger/viewTicket/' . $result['ticket_id']); ?>"># <?php echo $result['ticket_number'] ?></a>
                                                </td>
                                                        ...
                                                        ?>
                                                                ...
                                                                <?php else : ?>
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changePriority/' . $result['ticket_id'] . "/2"); ?>"><i class="fa fa-dot-circle-o text-danger"></i>
                                                                            Critical</a>
                                                                        <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changePriority/' . $result['ticket_id'] . "/1"); ?>"><i class="fa fa-dot-circle-o text-warning"></i>
                                                                            High</a>
                                                                    </div>
                                                                <?php endif; ?>
                                                            <?php
                                                            ...
                                                            ?>
                                                                ...
                                                                <?php else : ?>
                                                                    <a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="javascript:void(0);" data-toggle="dropdown" aria-expanded="false">
                                                                        ...
                                                                        High </a>
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changePriority/' . $result['ticket_id'] . "/0"); ?>"><i class="fa fa-dot-circle-o text-primary"></i>
                                                                            Normal</a>
                                                                        <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changePriority/' . $result['ticket_id'] . "/2"); ?>"><i class="fa fa-dot-circle-o text-danger"></i>
                                                                            Critical</a>
                                                                    </div>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <select class="form-control" onchange="location = this.value;">
                                                        <option value="#">Select Status</option>
                                                        <option value="<?= site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/1") ?>" <?= ($result['ticket_status'] == 're_open' ? 'selected' : '') ?>>Reopened</option>
                                                        <option value="<?= site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/4") ?>" <?= ($result['ticket_status'] == 'in_progress' ? 'selected' : '') ?>>In Progress</option>
                                                        <option value="<?= site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/2") ?>" <?= ($result['ticket_status'] == 'hold' ? 'selected' : '') ?>>Closed - Observation Raised</option>
                                                        <option value="<?= site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/3") ?>" <?= ($result['ticket_status'] == 'closed' ? 'selected' : '') ?>>Closed - No Further Action</option>
                                                        <option value="<?= site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/5") ?>" <?= ($result['ticket_status'] == 'cancelled' ? 'selected' : '') ?>>Closed - NC Raised</option>
                                                    </select>
                                                    <!-- <div class="dropdown action-label">
                                                        ...
                                                        <a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
                                                            <i class="fa fa-dot-circle-o text-info"></i><?= $result['ticket_status'] ?>
                                                        </a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/1"); ?>"><i class="fa fa-dot-circle-o text-info"></i>
                                                                Reopened</a>
                                                            <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/2"); ?>"><i class="fa fa-dot-circle-o text-danger"></i> In Progress
                                                            </a>
                                                            <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/3"); ?>"><i class="fa fa-dot-circle-o text-success"></i> Closed - No Further Action
                                                            </a>
                                                            <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/4"); ?>"><i class="fa fa-dot-circle-o text-success"></i> Closed - Observation Raised
                                                            </a>
                                                            <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/5"); ?>"><i class="fa fa-dot-circle-o text-danger"></i> Closed - NC Raised
                                                            </a>
                                                        </div>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a class="edt-tckt" href="javascript:void(0);" id='<?php echo $result['ticket_id']; ?>' data-info="<?php echo $result['ticket_id']; ?>" data-toggle="modal" data-target="#edit_ticket"><i class="fa fa-pencil m-r-5"></i></a>
                                                    <a class="del-tckt" href="javascript:void(0);" data-info="<?php echo $result['ticket_id']; ?>" data-toggle="modal" data-target="#delete_ticket"><i class="fa fa-trash-o m-r-5"></i></a>
                                                            ...
                                                            ?>
                                                                ...
                                                                ?>
                                                                    <?php if (!$this->lab_enquiries->isLabAdmin()) : ?>
                                                                        ...
                                                                        <a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#">
                                                                            <i class="fa fa-dot-circle-o text-danger"></i>Closed - NC Raised
                                                                        </a>
                                                                    <?php else : ?>
                                                                        <a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
                                                                            <i class="fa fa-dot-circle-o text-danger"></i>Closed - NC Raised
                    ...
                    <!-- <div class="tab-pane" id="further_work">
                        <h2>Further Work</h2>
                        <?php if (empty($fwTicketsData)) {
                            echo "<p>No Incident To Show...</p>";
                        } else {  ?>
                            <div class="table-responsive">
                                        ...
                                        foreach ($fwTicketsData as $result) : ?>
                                            ...
                                            <tr>
                                                <td><?php echo $count;
                                                    $count++; ?></td>
                                                <td>
                                                    <a href="<?= site_url('Incident_Ledger/viewTicket/' . $result['ticket_id']); ?>"># <?= $result['ticket_number'] ?></a>
                                                </td>
                                                    ...
                                                    <div class="dropdown action-label">
                                                        ...
                                                        ?>
                                                                ...
                                                                <?php else : ?>
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="<?= site_url('Incident_Ledger/changePriority/' . $result['ticket_id'] . "/2"); ?>"><i class="fa fa-dot-circle-o text-danger"></i>Critical</a>
                                                                        <a class="dropdown-item" href="<?= site_url('Incident_Ledger/changePriority/' . $result['ticket_id'] . "/1"); ?>"><i class="fa fa-dot-circle-o text-warning"></i>High</a>
                                                                    </div>
                                                                <?php endif; ?>
                                                            ...
                                                            ?>
                                                                ...
                                                                <?php else : ?>
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="<?= site_url('Incident_Ledger/changePriority/' . $result['ticket_id'] . "/0"); ?>"><i class="fa fa-dot-circle-o text-primary"></i>Normal</a>
                                                                        <a class="dropdown-item" href="<?= site_url('Incident_Ledger/changePriority/' . $result['ticket_id'] . "/2"); ?>"><i class="fa fa-dot-circle-o text-danger"></i>Critical</a>
                                                                    </div>
                                                                <?php endif; ?>
                                                            <?php
                                                        ...
                                                        ?>
                                                                ...
                                                                <?php else : ?>
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/1"); ?>"><i class="fa fa-dot-circle-o text-info"></i>
                                                                            Reopened</a>
                                                                        <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/2"); ?>"><i class="fa fa-dot-circle-o text-danger"></i> On
                                                                            Hold</a>
                                                                        <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/3"); ?>"><i class="fa fa-dot-circle-o text-success"></i>
                                                                            Closed</a>
                                                                        <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/4"); ?>"><i class="fa fa-dot-circle-o text-success"></i> In
                                                                            Progress</a>
                                                                        <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/5"); ?>"><i class="fa fa-dot-circle-o text-danger"></i>
                                                                            Cancelled</a>
                                                                    </div>
                                                                <?php endif; ?>
                                                            <?php
                                                            ...
                                                            ?>
                                                                ...
                                                                <?php else : ?>
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/0"); ?>"><i class="fa fa-dot-circle-o text-info"></i>
                                                                            Open</a>
                                                                        <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/2"); ?>"><i class="fa fa-dot-circle-o text-danger"></i> On
                                                                            Hold</a>
                                                                        <a class="dropdown-item" href="<?php echo site_url('Incident_Ledger/changeStatus/' . $result['ticket_id'] . "/3"); ?>"><i class="fa fa-dot-circle-o text-success"></i>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?= form_open(base_url('Incident_Ledger/manage_category')); ?>
                    <div class="row">
                        <div class="col-sm-12">
                                            ...
                                            foreach ($category_list as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="<?= base_url('Incident_Ledger/delete_category/') . $row['id']; ?>"><i class="fa fa-trash-o m-r-5"></i></a>
                                                    </td>
                                                </tr>
                                            <?php }
                                        } else { ?>
