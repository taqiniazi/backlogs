    ...
    $(document).ready(function(){
            ...
            "columns": [
                {
                    ...
                    render: function (data, type, row, meta) {
                        return '<input type="checkbox" name="bill_track[]" class="checkSingle" />'
                    }
                },
                {data: 'lab_number'},
                {data: 'pci_number'},
        ...
        $("body").on("click", "#invoice_generate", function(){
            ...
            $.ajax({
                ...
                data: { 'clinic_id': clinicId, 'invoice_number': invoiceNumber, 'quantity': quantity, 'total_amount': totalAmount, [csrf_name]: csrf_hash },
                dataType: "json",
                success: function (response) {
                    if (response.status === 'success') {
