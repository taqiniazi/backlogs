    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn add-btn" target="_blank" href="javascript:void(0);"id="invoice_url">Continue</a>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("body").on("click", ".bill_track_view", function (){
            // $(document).find('#invoice_generate').trigger('click');
            // $('#preview_invoice_modal').modal('show');
            // return false;
            ...
            $("#billTrackData").DataTable({
                "ajax": {
                    "url": _base_url + "billing/get_bill_track_data/" + clinic_id,
                    "dataSrc": 'data'
                },
                "processing": true,
                "autoWidth": true,
        ...
        $("body").on("click", "#invoice_generate", function(){
            ...
            $.ajax({
                ...
                data: { 'clinic_id': clinicId, [csrf_name]: csrf_hash },
                dataType: "json",
