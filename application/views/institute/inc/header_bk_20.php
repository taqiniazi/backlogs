        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item dropdown has-arrow flag-nav">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button">
                    <img src="<?php echo base_url('/assets/newtheme/img/flags/us.png'); ?>" alt="" style="height:20px;"> <span>English</span>
                </a>
            ...
            <li class="nav-item dropdown">
                <a href="#" class="dropdown-toggle nav-link comments" data-toggle="dropdown">
