                     ...
                     <option value="<?php echo $hosValues["id"] ?>"  ><?php echo $hosValues["description"]; ?></option>
                        ...
                        <div class="col-md-3"  style="float:left">
                            <div class="card">
                                ...
                                <input type="text" readonly="readonly"  disabled="disabled" id="lab_name_pre_show2" value="<?php echo $lab_des[0]["description"]; ?>" name="lab_name_pre_show" class="form-control">
                        ...
                        <div class="col-md-3"  style="float:left">
                            <div class="card">
                                <div class="row card-body nopadding">
                                    ...
                                    <div class="col-md-12 form-group">
                                        <label for="focus-label">Specialty</label>
                            ...
                            <div class="card">
                                <div class="row card-body nopadding">
                                     <div class="col-md-12 form-group ">
                                        ...
                                        <input type="text" name="specimen_no_pre" id="specimen_no_pre" value="" disabled="disabled" class="form-control input-lg">
                                    </div>
                                        ...
                                        <label class="focus-label">Courier ID</label>
                                         <select name="courier_no_pre" id="courier_no_pre" disabled="disabled" class="form-control  input-lg select2">
                                            ...
                                            foreach ($courier_data as $courier_l) {
                                                //$snomed_t = strtolower(str_replace(' ', '', trim($snomed_t_code['usmdcode_code'])));
                                                ?>
                                                <option value="<?php echo $courier_l->courier_no ?>" data-id="<?= $courier_l->id; ?>"><?= $courier_l->courier_no; ?> / <?= date('y-m-d',strtotime($courier_l->courier_sent_at)); ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
...
<input type="hidden" name="bookingin_lab_id" id="bookingin_lab_id"  value="128" />
...
<div class="col-md-6 form-group ">
                                            ...
                                            <div id="spctype_div d-flex">
                                                ...
                                                <label>
                                                    <input type="checkbox" name="matching" onchange="show_hide('spe_no')"  /> Matching </label>
                                            </div>
                                        </div>
...
<div id="speciman_type_div" class="row">
