                ...
                <div class="card profile-box flex-fill">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Nata Number</label>
                                    <input class="form-control" name="laboratory_nata_num" id="laboratory_nata_num" value="<?php echo $errors ? $form_data['laboratory_nata_num']['value'] : ''; ?>" type="text">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
