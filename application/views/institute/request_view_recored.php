...
<div class="content tabelewidth container-fluid publish-record">
    <div class="row">
    <div class="speace-setup col-sm-12 col-md-12 col-lg-12">
    ...
    <div class="col-md-12">
        ...
        <table id="display_submitted_records" class="table table-striped custom-table datatable" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                $flag_count = 11;
                if (count($query) == 0) {
                    echo '<p class="no_work bg-danger">Sorry there is no record yet. Kindly Add Request to see the submitted request.</p>';
                } else {
