                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="enter_hospital form-control <?php if ($errors) echo empty($form_data['hospital_name']['error']) ? 'is-valid' : 'is-invalid' ?>" <?php if ($errors) echo empty($form_data['hospital_name']['error']) ? '' : 'aria-invalid="true"' ?> name="hospital_name" id="hospital_name" type="search" value="<?php echo $errors ? $form_data['hospital_name']['value'] : ''; ?>">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php if ($errors) echo empty($form_data['hospital_initials_1']['error']) ? 'is-valid' : 'is-invalid';  ?>" <?php if ($errors) echo empty($form_data['hospital_initials_1']['error']) ? '' : 'aria-invalid="true"' ?> name="hospital_initials_1" id="hospital_initials_1" maxlength="1" type="text" value="<?php echo $errors ? $form_data['hospital_initials_1']['value'] : ''; ?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php if ($errors) echo empty($form_data['hospital_initials_2']['error']) ? 'is-valid' : 'is-invalid';  ?>" <?php if ($errors) echo empty($form_data['hospital_initials _2']['error']) ? '' : 'aria-invalid="true"' ?> name="hospital_initials_2" id="hospital_initials_2" maxlength="1" type="text" value="<?php echo $errors ? $form_data['hospital_initials_2']['value'] : ''; ?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Address</label>
                                    <input class="form-control" autocomplete="off" name="hospital_address" id="hospital_address" value="<?php echo $errors ? $form_data['hospital_address']['value'] : ''; ?>" type="text">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-3">
                                <div class="form-group">
                                    <label>City</label>
                                    <input class="form-control" name="hospital_city" id="hospital_city" value="<?php echo $errors ? $form_data['hospital_city']['value'] : ''; ?>" type="text">
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-3">
                                <div class="form-group">
                                    <label>State/Province</label>
                                    <input class="form-control" type="text" name="hospital_state" id="hospital_state" placeholder="" value="<?php echo $errors ? $form_data['hospital_state']['value'] : ''; ?>">
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-6 col-lg-3">
                                <div class="form-group">
                                    <label>Postal Code</label>
                                    <input class="form-control" name="hospital_post_code" <?php echo $errors ? $form_data['hospital_post_code']['value'] : ''; ?> id="hospital_post_code" value="" type="text">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Email</label>
                                    <input autocomplete="off" class="form-control <?php if ($errors) echo empty($form_data['hospital_email']['error']) ? 'is-valid' : 'is-invalid' ?>" <?php if ($errors) echo empty($form_data['hospital_email']['error']) ? '' : 'aria-invalid="true"' ?> name="hospital_email" id="hospital_email" value="<?php echo $errors ? $form_data['hospital_email']['value'] : ''; ?>" type="email">
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="hospital_number" id="hospital_number" value="<?php echo $errors ? $form_data['hospital_number']['value'] : ''; ?>" type="text">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="hospital_mobile_num" id="hospital_mobile_num" value="<?php echo $errors ? $form_data['hospital_mobile_num']['value'] : ''; ?>" type="text">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Fax</label>
                                    <input class="form-control" name="hospital_fax" id="hospital_fax" value="<?php echo $errors ? $form_data['hospital_fax']['value'] : ''; ?>" type="text">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Website Url</label>
                                    <input class="form-control <?php if ($errors) echo empty($form_data['hospital_website']['error']) ? 'is-valid' : 'is-invalid' ?>" <?php if ($errors) echo empty($form_data['hospital_website']['error']) ? '' : 'aria-invalid="true"' ?> name="hospital_website" id="hospital_website" value="<?php echo $errors ? $form_data['hospital_website']['value'] : ''; ?>" type="text">
                                    <div class="invalid-feedback">
