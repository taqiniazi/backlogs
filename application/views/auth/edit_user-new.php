...
$certData =  $this->db->get_where('user_certificates', array('user_id' => $user_id))->row();
// Include Forms File
?>
...
<div class="card mb-0">
                                ...
                                <div class="profile-info-left">
                                    ...
                                    foreach ($groups_list as $key => $value) {
                                        ...
                                        if ($group_type[0]->group_type === $key2->group_type) {
                                            //<strong>Member of</str Member of ong> <h6 class="text-muted"><?=html_purify($value) : <?=html_purify($key2->name)</h6>
                                            ?>
   ...
   <div class="col-lg-4 col-md-12 mb-2" style="float:right; margin-bottom: 10% !important; padding-bottom:15%;">
    <?php echo form_open('/auth/unlock_user') ?>

<input type="submit" class="btn btn-block btn-success" value="Unlock Login" style="position: absolute; right: 100px; top: 100px;"></input>
...
<?php endif; ?>    
                            ...
                            <div class="col-md-7">
                                <ul class="personal-info thumb_view">
                                    ...
                                    <?php if($user_details['provider_no'] != ''){ ?>
                                    <li>
                                        <div class="title">Provider No:</div>
                                        <div class="text"><?php echo $user_details['provider_no'] ?></div>
                                    </li>
                                    <?php } ?>
    ...
    <div class="user-tabs">
        <div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
            <ul class="nav nav-tabs nav-tabs-bottom">
                ...
                <?php if ($group_type[0]->group_type == 'D') { ?>
                ...
                <li class="nav-item"><a href="#location" data-toggle="tab" class="nav-link">Location <small
                                class="text-danger"></small></a></li>
                                <?php } ?>
...
<div class="tab-content">
    ...
    <div id="emp_profile" class="pro-overview tab-pane fade show active">
        <div class="row">
                ...
                <div class="card profile-box flex-fill">
                    <div class="card-body">
                        <h3 class="card-title">Personal Informations
                            <a href="javascript:;" class="edit-icon" data-toggle="modal" data-target="#profile_info"><i class="fa fa-pencil"></i></a>
            ...
            <!-- Div for Certificate form -->
            <div class="col-md-6 d-flex">
                <div class="card profile-box flex-fill">
                    <div class="card-body">
                        <h3 class="card-title">Certificate &nbsp;&nbsp;&nbsp;&nbsp;<label style="font-size: 18px">Appove</label>
                            <input type="checkbox" data-toggle="toggle">
                            <a href="javascript:;" class="edit-icon" data-toggle="modal" data-target="#certificate_info"><i class="fa fa-pencil"></i></a>
                        </h3>
                        <h5 class="section-title"></h5>
                        <hr>
                         ...
                         <ul class="personal-info thumb_view">
                            <li>
                                ...
                                <div class="text"><?php echo $certData->certificate_title ? $certData->certificate_title : 'Title Not Added'; ?></div>
                            </li>
                            <li>
                                <div class="title">Date of Certification</div>
                                <div class="text"><?php echo $certData->certificate_date ? $certData->certificate_date : 'Date Not Added' ?></div>
                            </li>
                            <li>
                                <div class="title">Institution Name</div>
                                <div class="text"><?php echo $certData->institution_name ? $certData->institution_name : 'Institution Not Added' ?></div>
                            </li>
                            <li>
                                <div class="title">City</div>
                                <div class="text"><?php echo $certData->certificate_city ? $certData->certificate_city : 'City Not Added' ?></div>
                            </li>
                            <li>
                                <div class="title">Country</div>
                                <div class="text"><?php echo($certData->certificate_country != "" ? $certData->certificate_country : "Country Not Added") ?></div>
                            </li>
                            <li>
                                <div class="title">In person or Online</div>
                                <div class="text"><?php echo($certData->online_personally == '2'? "Online" : "In Person") ?></div>
                            </li>
                            <li>
                                <div class="title">Duration of Course</div>
                                <div class="text"><?php echo $certData->duration_course_to .'TO'. $certData->duration_course_from; ?></div>
                            </li>
                            <li>
                                <div class="title">System Admin Approval</div>
                                <div class="text"><?php echo($certData->admin_approved == 1 ? 'Approved' : "Unapproved") ?></div>
                            </li>
            ...
            <div class="col-md-6 d-flex">
                <div class="card profile-box flex-fill">
                    <div class="card-body">
                        <h3 class="card-title">Connecting Practice                            
                        </h3>
                        
                        <?php
                        //print $user_id;
                                                        $get_hos_names = $this->Userextramodel->display_doctor_only_hospitalsbyID($user_id);
                                                        $get_lab_names = $this->Userextramodel->display_doctor_only_labbyID($user_id);
                                                        //echo $this->db->last_query();

                                                        if(count($user_member_groupsInfo) > 0){
                                                            foreach($user_member_groupsInfo as $key3 => $group){
                                                                $selected = 'selected';
                                                                echo '<p data-labnameid="' . $group['id'] . '" ' . $selected . ' value="' . $group['id'] . '"> > ' . ucwords($group['name']) . '</p>';
                                                            }
                                                        }
                                                        ...
                                                        if (!empty($get_hos_names) && is_array($get_hos_names)) :
                                                            foreach ($get_hos_names as $hos_key => $hos_val) 
                                                            {
                                                                ...
                                                                $selected = '';
                                                                if ($hos_val->group_id == $row->hospital_group_id) 
                                                                {
                                                                    $selected = 'selected';
                                                                }
                                                                echo '<p data-labnameid="' . $hos_val->group_id . '" ' . $selected . ' value="' . $hos_val->group_id . '"> > ' . ucwords($hos_val->description) . '</p>';
                                                            }
                                                        endif;
                                                        if (!empty($get_lab_names) && is_array($get_lab_names)) :
                                                            foreach ($get_lab_names as $hos_key => $hos_val) 
                                                            {
    ...
    <div class="tab-pane fade" id="location">
        <div class="card">
            <div class="card-body">
                ...
                <?php echo form_open(base_url() . 'index.php/auth/updateUserLocation/' . $user->id, array('class' => 'form tg-formtheme tg-editform')); ?>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="location_add" class="form-control"
                                   value="<?php echo($user_details['account_number'] != "" ? $user_details['account_number'] : "No Data") ?>">
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 1200px!important;" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open_multipart(uri_string(), array('class' => 'form tg-formtheme tg-editform', 'id' => 'edit-form')); ?>
                ...
                <input type="hidden" id="user_pre_sub_role" value="<?php echo $user->sub_role; ?>">
                <input type="hidden" id="admin_type" value="<?php echo (!$this->ion_auth->in_group('admin')?"no":"yes"); ?>">

                <textarea id="user_pre_member_groups" style="display: none"><?php echo json_encode($user_member_groups); ?></textarea>
                ...
                <div class="row">
                    ...
                    //                                    ?>
                    <!--                                    <option value="-->
                    <?php //echo $rec->id ?><!--" --><?php //echo $selected; ?>
                    <?php //echo html_purify($rec->name); ?><!--</option>-->
                    <!--                                    --><?php
                    //                                } ?>
                    <!--                            </select>-->
                    <!--                        </div>-->
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Role</label>
                            <select class="select form-control" id="select_roles" name="select_roles">
                                <!-- onchange="checkchildgroup(this)" -->
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="select form-control" name="child_user_group[]" id="child_user_groups"
                                    onchange="checkchildpathologistgroup(this)" multiple>
...
//                                        }
//                                        ?>
<!--                                        <option value="--><?php //echo $childgroup['id']; ?><!--"-->
<!--                                                data-grouptype="--><?php //echo $childgroup['group_type']; ?><!--" --><?php //echo $selected; ?><!-- >--><?php //echo $childgroup['description']; ?><!--</option>-->
<!--                                    --><?php //}
//                                } ?>
<!--                                <option value="89" data-grouptype="HA">Clinic System Admin</option>-->
<!--                                <option value="6" data-grouptype="D">Pathologist</option>-->
                            </select>
                    ...
                    <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="provider_no" class="form-control" name="provider_no"
                                           value="<?php echo $user_details['provider_no'] ?>">
                                </div>
                            </div>

                    <div style="display:none" class="col-md-6 <?php echo $show_pathologist_groups; ?>"
                         id="pathologist_role_div">
                        <div class="form-group">
                            <label>Pathologist Group</label>
                            <select class="select form-control" name="child_pathologist_user_group"
                                    id="child_pathologist_user_group" onchange="checkPathologistManager(this)">
                                <option value="">Choose Role</option>
                                <?php if (!empty($child_pathologist_groups)) {
                                    foreach ($child_pathologist_groups as $childpathologist) {
                                        ?>
                                        <option value="<?php echo $childpathologist['id']; ?>"
                                                data-grouptype="<?php echo $childpathologist['group_type']; ?>" <?php echo(($childpathologist['id'] == $user_child_group['id']) ? 'selected' : ''); ?> ><?php echo $childpathologist['name']; ?></option>
                                    <?php }
                                } ?>
                            </select>
                            <label id="child_pathologist_user_group-error" class="error"
                                   for="child_pathologist_user_group"></label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 <?php echo $show_pathologist_users; ?>" id="pathologist_manager_div">
                        <div class="form-group">
                            ...
                            <select class="select form-control" name="manager_pathologist[]" multiple="multiple"
                                    id="manager_pathologist">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" name="post_code" type="text"
                                   value="<?php echo $user_details['post_code'] ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="form-group row tg-inputwithicon">
                        ...
                        <div class="col-sm-8">
                            <div class="row init_pin">
                                ...
                                <input type="password" id="1" class="form-control show_pass pre_pin col-lg-2"
                                       maxlength="1"
                                       data-class="pre_pin" name="pre_pin[]" style="margin-left: 12px">
                                <input type="password" id="2" class="form-control show_pass pre_pin col-lg-2"
                                       maxlength="1"
                                       data-class="pre_pin" name="pre_pin[]" style="margin-left: 12px">
                                <input type="password" id="3" class="form-control show_pass pre_pin col-lg-2"
                                       maxlength="1"
                                       data-class="pre_pin" name="pre_pin[]" style="margin-left: 12px">
                                <input type="password" id="4" class="form-control show_pass pre_pin col-lg-2"
                                       maxlength="1"
                                       data-class="pre_pin" name="pre_pin[]" style="margin-left: 12px">
                ...
                <div class="form-group row tg-inputwithicon">
                    ...
                    <div class="col-sm-8">
                        <div class="row init_pin">
                            ...
                            <input type="password" id="5" class="form-control show_pass user_pin col-lg-2" maxlength="1"
                                   data-class="user_pin" name="user_pin[]" style="margin-left: 12px">
                            <input type="password" id="6" class="form-control show_pass user_pin col-lg-2" maxlength="1"
                                   data-class="user_pin" name="user_pin[]" style="margin-left: 12px">
                            <input type="password" id="7" class="form-control show_pass user_pin col-lg-2" maxlength="1"
                                   data-class="user_pin" name="user_pin[]" style="margin-left: 12px">
                            <input type="password" id="8" class="form-control show_pass user_pin col-lg-2" maxlength="1"
                                   data-class="user_pin" name="user_pin[]" style="margin-left: 12px">
...
<!-- Certificate MOdel -->
<div id="certificate_info" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <?php echo form_open('', array('class' => 'form tg-formtheme tg-editform')); ?>
                <?php echo form_hidden('action', 'update_certificate'); ?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Title</label>
                                    <input type="text" name="certificate_title" class="form-control" value="<?php echo $certData->certificate_title; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Date of Certification</label>
                                    <input type="text" name="certificate_date" class="form-control custom_datetimepicker" value="<?php echo $certData->certificate_date; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>City</label>
                                    <input class="form-control" name="certificate_city" type="text" value="<?php echo $certData->certificate_city; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Country</label>
                                    <input class="form-control" name="certificate_country" type="text" value="<?php echo $certData->certificate_country; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>In person or Online</label>
                                    <select class="form-control" name="online_personally">
                                        <option value="1" <?php if($certData->online_personally == 1) echo "selected"; ?>>In Person</option>
                                        <option value="2" <?php if($certData->online_personally == 2) echo "selected"; ?>>Online</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Institution Name</label>
                                     <input class="form-control" name="institution_name" type="text" value="<?php echo $certData->institution_name; ?>">
                                </div>
                            </div>
                           <!--  <div class="col-md-6">
                                <div class="form-group">
                                    <label>System Admin Approval</label>
                                    <input class="form-control" name="admin_approved" type="checkbox" <?php if($certData->admin_approved == 1) echo "checked";?>>
                                </div>
                            </div> -->
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="to" name="duration_course_to" class="form-control custom_datetimepicker" value="<?php echo $certData->duration_course_to; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>From</label>
                                    <input type="text" placeholder="from" name="duration_course_from" class="form-control custom_datetimepicker" value="<?php echo $certData->duration_course_from; ?>">
                                </div>
                            </div>
        ...
        var readURL = function (input) {
            if (input.files && input.files[0]) {
                ...
                if (files.length > 0) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url("auth/uploadProfilePic")?>',
                        type: 'post',
                        data: fd,
                        contentType: false,
                        processData: false,
...
$(document).ready(function () {
    $(".datetimepicker").datetimepicker({
     ...
     $( ".custom_datetimepicker" ).datepicker({ dateFormat: "yy-mm-dd" });
    ...
    $(".btn-user-unlock").on("click", function (e) {
        var dataId = $(this).attr("data-id");
        var user_id = $("#user_id").val();
        var email_id = $("#email_id").val();
        $.ajax({
            type: "POST",
            url: _base_url + '/auth/unlock_user',
            data: {dataId: dataId, user_id: user_id, email_id: email_id, [csrf_name]: csrf_hash},
            dataType: "json",
            success: function (response) {
                // var specimenId = $('#block_specimen_id').val();
                if (response.status === 'success') {
