            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <div>
                            <span class="text-success"><?php $centage = number_format(($ticketsCountData['new'] / $ticketsCountData['total']) * 100,2); echo $centage != 'nan' ? $centage :0;  ?>%</span>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <div>
                        <span class="text-success"><?php $centage = number_format(($ticketsCountData['closed'] / $ticketsCountData['total']) * 100,2); echo $centage != 'nan' ? $centage :0; ?>%</span>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <div>
                        <span class="text-success"><?php $centage = number_format(($ticketsCountData['in_progress'] / $ticketsCountData['total']) * 100,2); echo $centage != 'nan' ? $centage :0; ?>%</span>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <div>
                            <span class="text-success"><?php $centage = number_format(($ticketsCountData['pending'] / $ticketsCountData['total']) * 100,2); echo $centage != 'nan' ? $centage :0;  ?>%</span>
                        </div>
                    </div>
