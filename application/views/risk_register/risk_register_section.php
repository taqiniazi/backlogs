                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group tg-inputwithicon">     
                                            ...
                                            <select name="risk_level" class="form-control">
                                                <option value="E" <?php echo $result['risk_level'] == 'E' ? 'selected':'' ?> >Extreme</option>
                                                <option value="H" <?php echo $result['risk_level'] == 'H' ? 'selected':'' ?>>High</option>
                                                <option value="M" <?php echo $result['risk_level'] == 'M' ? 'selected':'' ?>>Moderate</option>
                                                <option value="L" <?php echo $result['risk_level'] == 'L' ? 'selected':'' ?>>Low</option>
                                            </select>
                                        </div>
                                    </div> 
