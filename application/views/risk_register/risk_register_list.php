...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            <h3 class="page-title">Risk Management</h3>
            <ul class="breadcrumb">
        ...
        <div class="col-auto float-right ml-auto">           
                <a href="<?php echo base_url('Risk_Register/risk_register_section/0'); ?>" class="btn add-btn"><i class="fa fa-plus"></i>Add Risk</a>
				
				
				<a href="<?php echo base_url('Risk_Register/Severity_list'); ?>" class="btn add-btn mr-2"><i class="fa fa-list-alt"></i> Severity </a>
				
				<a href="<?php echo base_url('Risk_Register/sub_category_list'); ?>" class="btn add-btn mr-2"><i class="fa fa-list-alt"></i> Sub Category </a>
			
				<a href="<?php echo base_url('Risk_Register/category_list'); ?>" class="btn add-btn  mr-2"><i class="fa fa-list-alt"></i>  Category </a>
        ...
        <table class="table table-striped no-footer" id="risk_register_datatable1" style="width: 100%;">
            <thead>        
				...
				foreach($result as $row){
                    ...
                    <td '.$tdColor.'>'.substr($row['risk_description'],0,35).'...</td>
