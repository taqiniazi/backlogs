...
#add_courier_modal .modal-dialog {
    max-width: 1000px;
}
#add_courier_modal .custom-modal .modal-body{
    padding: 30px 15px;
}
#add_courier_modal .choose_courier_comp a{
    font-size:14px;
}
                                ...
                                <div class="col-md-12 courier-new">
                                    ...
                                    <img title="<?php print $userinfo[0]->first_name.' '.$userinfo[0]->last_name; ?>" style="border-radius: 50%;width: 25px;height: 25px"
                                         ...
                                         alt="<?php print $userinfo[0]->first_name.' '.$userinfo[0]->last_name; ?>">
                                                    ...
                                                    <td class="center"><?php if(strtotime($row['stamp_date'])>strtotime("2018-01-01 01:01:01")) { echo($row['stamp_date'] == "" ? "" : date("d-m-Y h:i a", strtotime($row['stamp_date']))); } else { print "--";  } ?></td>
                                                    <!--<td>
                                     ...
                                     <a class="edt-tckt"
                                                                ...
                                                                <a class=" del-tckt"
                                                                   ...
                                                                   data-target="#delete_ticket"><i
                                                                            ...
                                                                            <?php } ?>
                                                                <a class="" href="<?php echo base_url() ?>addCourier/trackCourier/<?php echo base64_encode($row['id']) ?>">
                                                                    <i class="fa fa-truck m-r-5"></i></a>

                                                                <a class="" href="<?= base_url() ?>addCourier/stamp_date_add/<?= $row['id']; ?>"><i class="fa fa-check m-r-5"></i>  </a>
...
//                    echo form_open('', $attributes);
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <input type="text" name="consignment_no" id="consignment_no" value="CN<?=rand(4,10000)?>" class="form-control floating">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group ">
                    ...
                    <div class="row">
                                ...
                                <select class="floating courier_user_dp" name="sender_search" id="sender_search"
                                    ...
                                    foreach ($user_data as $user) {
                                        ...
                                        <option data-address="<?php echo $user->address1; ?>"
                                                ...
                                                value="<?php echo $user->user_id; ?>" <?php echo ($user->user_id == 457 ? "selected" : "sss") ?>><?php echo $user->first_name . " " . $user->last_name; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5 form-group">
                            <div class=" select-focus">
                                ...
                                <select class="floating courier_user_dp" name="receiver_search" id="receiver_search"
                                        style="width: 100%">
                                    <option value=""> -- Select --</option>
                                    <?php
                                    foreach ($user_data as $user) { ?>
                                        <option data-address="<?php echo $user->address1; ?>"
                                                data-phone="<?php echo $user->phone; ?>"
                                                data-address2="<?php echo $user->address2; ?>"
                                                title="https://pathhub.fnqhpathology.com/<?php echo $user->profile_picture_path; ?>"
                                                value="<?php echo $user->user_id; ?>" <?php if($user->user_id=='460') { ?> selected='selected' <?php } ?>><?php echo $user->first_name . " " . $user->last_name; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <select class="floating select2" name="receiver_organization" id="receiver_organization"
                                        style="width: 100%">
                                        <option value="128" data-address="" selected="" data-select2-id="35">FNQH Pathology Pty Ltd</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control floating" id="sender_address" value="24/161 Pease St, Manoora QLD 4870, Australia" name="sender_address" readonly>
                            </div>
                        </div>
                        <div class="col-md-6 form-group">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control floating" id="receiver_address"
                                       name="receiver_address" value="24/161 Pease St, Manoora QLD 4870, Australia" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <div class="form-group">
                                <label class="focus-label">Upload Check List 1</label>
    ...
    <div id="request_list_modal" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Linked Request</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div id="view_document_modal" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
