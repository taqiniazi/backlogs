                                ...
                                <div class="col-md-12">
                                    ...
                                    <table id="courier_listing_table"
                                        ...
                                        if (!empty($couriers)) {
                                            ...
                                            foreach ($couriers as $row) {
                                                $generated_user_id = $this->Courier_model->generate_userids($row['created_by']);
                                                ?>
                                                <tr class="">

                                                    <td class=""><strong><?php echo $row['initials'] . "-" . $row['courier_no']; ?></strong></td>
                                                    <!--                            <td class="">-->
                                    ...
                                    <img title="<?php print $userinfo[0]->first_name.' '.$userinfo[0]->last_name; ?>" style="border-radius: 50%;width: 25px;height: 25px"
                                         ...
                                         alt="<?php print $userinfo[0]->first_name.' '.$userinfo[0]->last_name; ?>">
                                                    ...
                                                    <td class=""><?= $row['sender_email'] . " (". $row['sender_org']. ")"; ?><i class="las la-hospital" title="<?php echo "Address: ".$row['sender_address1']; ?>"></i></td>
                                                    
                                                    <td class=""><?= $row['receiver_email'] . " (". $row['receiver_org']. ")"; ?><i class="las la-hospital" title="<?php echo "Address: ".$row['receiver_address1']; ?>"></i></td>
...
//                    echo form_open('', $attributes);
                    ...
                    <!--  <div class="row">
                         ...
                         <div class="col-sm-6">
                             <div class="form-group  select-focus">
                                 <select class="select2 floating" name="courier_company" id="courier_company" style="width: 100%">
                                     <option value=""> -- Select --</option>
                    ...
                    <div class="submit-section">
                        <button class="btn btn-primary tck-smbt-btn save-courier" type='submit'>Create Request</button>
                    </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
