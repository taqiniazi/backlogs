        ...
        <tr>
            ...
            if ($category->id == 1 || $category->id == 6 || $category->id == 9) {
                ...
                <td style="background-color: <?php echo (date("d-m-Y", strtotime("+1 day", strtotime($first_date))) == date("d-m-Y")) ? "#00c5fb" : ""; ?> <?php echo (date('d-m-Y', strtotime($y . "W" . $week)) < date("d-m-Y")) ? "#F7F7F7" : ""; ?>;">
                    ...
                    <input disabled type='text' value="<?php echo $day2_userid[0] ?>" name="dis_<?php echo date("d-m-Y", strtotime("+1 day", strtotime($first_date))); ?>[<?php echo $category->id; ?>]" class="timesheet_input_new timesheet_<?php echo date("d-m-Y", strtotime("+1 day", strtotime($first_date))) ?>">
                    ...
                    <img title="<?php print $userinfo2[0]->first_name; ?> <?php print $userinfo2[0]->last_name; ?>" class="avatar" src="<?= $day2Image; ?>" <?= $d; ?>>
                ...
                <td style="background-color: <?php echo (date("d-m-Y", strtotime("+2 day", strtotime($first_date))) == date("d-m-Y")) ? "#00c5fb" : ""; ?>;">
                    ...
                    <input disabled type='text' value="<?php echo $day3_userid[0] ?>" name="dis_<?php echo date("d-m-Y", strtotime("+2 day", strtotime($first_date))); ?>[<?php echo $category->id; ?>]" class="timesheet_input_new timesheet_<?php echo date("d-m-Y", strtotime("+2 day", strtotime($first_date))) ?>">
                    ...
                    <img title="<?php print $userinfo3[0]->first_name; ?> <?php print $userinfo3[0]->last_name; ?>" class="avatar" src="<?= $day3Image; ?>" <?= $d; ?>>
                ...
                <td style="background-color: <?php echo (date("d-m-Y", strtotime("+3 day", strtotime($first_date))) == date("d-m-Y")) ? "#00c5fb" : ""; ?>;">
                    ...
                    <input disabled type='text' value="<?php echo $day4_userid[0] ?>" name="dis_<?php echo date("d-m-Y", strtotime("+3 day", strtotime($first_date))); ?>[<?php echo $category->id; ?>]" class="timesheet_input_new timesheet_<?php echo date("d-m-Y", strtotime("+3 day", strtotime($first_date))) ?>">
                    ...
                    <img title="<?php print $userinfo4[0]->first_name; ?> <?php print $userinfo4[0]->last_name; ?>" class="avatar" src="<?= $day4Image; ?>" <?= $d; ?>>
                ...
                <td style="background-color: <?php echo (date("d-m-Y", strtotime("+4 day", strtotime($first_date))) == date("d-m-Y")) ? "#00c5fb" : ""; ?>;">
                    ...
                    <input disabled type='text' value="<?php echo $day5_userid[0] ?>" name="dis_<?php echo date("d-m-Y", strtotime("+4 day", strtotime($first_date))); ?>[<?php echo $category->id; ?>]" class="timesheet_input_new timesheet_<?php echo date("d-m-Y", strtotime("+4 day", strtotime($first_date))) ?>">
                    ...
                    <img title="<?php print $userinfo5[0]->first_name; ?> <?php print $userinfo5[0]->last_name; ?>" class="avatar" src="<?= $day5Image; ?>" <?= $d; ?>>
