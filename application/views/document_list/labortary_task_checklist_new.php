...
<style>
    ...
    #update_timesheet_new #timesheet_body_new input {
        height: 40px;
    ...
    #update_timesheet_new thead tr th {
        text-transform: capitalize;
    }

    #update_timesheet_new thead tr th .show_date {
        display: block;
    }
    ...
    #update_timesheet_new #timesheet_body_new input {
	 ...
	 #update_timesheet_new #timesheet_body_new input:hover {
    ...
    #update_timesheet_new #timesheet_body_new tr td i {
        padding-left: 0px !important;
    }

    #update_timesheet_new {
        background: #fff;
    ...
    #update_timesheet_new thead tr th,
    #update_timesheet_new #timesheet_body_new tr td {
        border: 1px solid #ddd;
        text-align: center;
    }
    ...
    #update_timesheet_new #timesheet_body_new .icon-cricle {
        width: 100%;
        max-width: 15px;
    }
    .icon_active {
...
<div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('Document_List/forms') ?>">Dashboard / Checklists / Monthly Stainer Checklist</a></li>
    ...
    <div class="table-responsive">
        ...
        <form action="<?= site_url('Document_List/update_weekly_timesheetData'); ?>" method="post" id="update_timesheet_new">
            <div class="col-auto ml-auto">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="card-title title-nav mb-0">
                            <div class="block-r"><a href="javascript:get_weekly_timesheet_new(-1)"><strong class="left-side"> Prev </strong></a></div>
                            <div class="block-r"><a href="javascript:get_weekly_timesheet_new(1)"><strong class="right-side"> Next </strong></a></div>
                            <div class="block-l"> <a href="javascript:get_weekly_timesheet_new(2)"><strong class="right-today"> Today </strong></a></div>
