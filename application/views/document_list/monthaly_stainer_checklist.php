...
<style>
    ...
    #monthly_stainer_checklist #monthly_timesheet_body input {
        height: 40px;
    ...
    #monthly_stainer_checklist thead tr th {
        text-transform: capitalize;
    }

    #monthly_stainer_checklist thead tr th .show_date {
        display: block;
    }
	...
	#monthly_stainer_checklist #monthly_timesheet_body input:hover {
    ...
    #monthly_stainer_checklist #monthly_timesheet_body tr td i {
        padding-left: 0px !important;
    }

    #monthly_stainer_checklist {
        background: #fff;
    ...
    #monthly_stainer_checklist thead tr th,
    #monthly_stainer_checklist #monthly_timesheet_body tr td {
        border: 1px solid #ddd;
        text-align: center;
    }
    ...
    #monthly_stainer_checklist #monthly_timesheet_body .icon-cricle {
        width: 100%;
        max-width: 15px;
    }
    /* .first {
...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            <h3 class="page-title"> Monthly Stainer Checklist</h3>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url('Document_List/forms') ?>">Dashboard / Checklists / Monthly Task Checklist</a></li>
            </ul>
        </div>
...
<form action="<?= site_url('Document_List/update_weekly_timesheetData'); ?>" method="post" id="monthly_stainer_checklist">
    <div class="col-auto ml-auto">
        <div class="row">
            <div class="col-sm-4">
                <div class="card-title title-nav mb-0">
                    <div class="block-r"><a href="javascript:monthly_stainer_checklist(-1)"><strong class="left-side"> Prev Week</strong></a></div>
                    <div class="block-r"><a href="javascript:monthly_stainer_checklist(1)"><strong class="right-side"> Next Week</strong></a></div>
                    <!-- <div class="block-l"> <a href="#"><strong class="right-today"> Today </strong></a></div> -->
                </div>
            </div>
            <div class="col-sm-4">
    ...
    <table class="table no-footer" id="revision_table_datatable" style="width: 100%;">
        ...
        <tbody id="monthly_timesheet_body">
