        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('Document_List/forms') ?>">Dashboard / Checklist / Laboratory Task Checklist</a></li>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="card-title title-nav mb-0">
                            <div class="block-r"><a href="javascript:get_weekly_timesheet(-1)"><strong class="left-side"> Prev Week </strong></a></div>
                            <div class="block-r"><a href="javascript:get_weekly_timesheet(1)"><strong class="right-side"> Next Week</strong></a></div>
