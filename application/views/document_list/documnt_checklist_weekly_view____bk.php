    ...
    foreach ($categories as $key => $category) {
        ...
        <tr>
            ...
            <td>
                ...
                <img class="icon-cricle update_time" data-get_class="<?php echo date('d-m-Y',strtotime($y."W".$week)); ?>[<?php echo $category->id; ?>]" src="<?php echo base_url('assets/img/icon-cricle.png'); ?>">
            ...
            <td>
                ...
                <img class="avatar" src="<?= $img; ?>" <?= $d; ?>>
                <img class="icon-cricle update_time" data-get_class="<?php echo date("d-m-Y",strtotime("+1 day", strtotime($first_date))); ?>[<?php echo $category->id; ?>]" src="<?php echo base_url('assets/img/icon-cricle.png'); ?>">
            </td>
            <td>
                ...
                <img class="avatar" src="<?= $img; ?>" <?= $d; ?>>
                <img class="icon-cricle update_time" data-get_class="<?php echo date("d-m-Y",strtotime("+2 day", strtotime($first_date))); ?>[<?php echo $category->id; ?>]" src="<?php echo base_url('assets/img/icon-cricle.png'); ?>">
            </td>
            <td>
                ...
                <img class="avatar" src="<?= $img; ?>" <?= $d; ?>>
                <img class="icon-cricle update_time" data-get_class="<?php echo date("d-m-Y",strtotime("+3 day", strtotime($first_date))); ?>[<?php echo $category->id; ?>]" src="<?php echo base_url('assets/img/icon-cricle.png'); ?>">
            </td>
            <td>
                ...
                <img class="avatar" src="<?= $img; ?>" <?= $d; ?>>
                <img class="icon-cricle update_time" data-get_class="<?php echo date("d-m-Y",strtotime("+4 day", strtotime($first_date))); ?>[<?php echo $category->id; ?>]" src="<?php echo base_url('assets/img/icon-cricle.png'); ?>">
            </td>
        </tr>
<?php }
} ?>