    ...
    <div class="row align-items-center">
        <div class="col">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url('Document_List') ?>">Document</a></li>
			 <li class="breadcrumb-item"><a href="<?php echo base_url('Document_List/category_list') ?>">Category</a></li>
		                       ...
		                       <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label>Category Name</label>
                                            ...
                                            <input type="text" name="name" id="document_number-input" value="<?php echo (isset($result['name']))?$result['name']:''; ?>" class="form-control" placeholder="Category Name">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label>Category Icon</label>
                                            <!-- <i class="lnr lnr-apartment"></i> -->
                                            <input type="text" name="icon" value="<?php echo (isset($result['icon']))?$result['icon']:''; ?>" class="form-control" placeholder="Category Icon">
