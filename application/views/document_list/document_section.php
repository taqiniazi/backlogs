...
<div class="">
    ...
    <?php echo form_open_multipart('', array('id' => 'add-document-form', 'class' => 'tg-formtheme tg-editform create_user_form')); ?>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group tg-inputwithicon">
                        ...
                        <?php
                        $decryptedDetails = $this->Userextramodel->getUserDecryptedDetailsByid($result['document_owner_id']);
                        ...
                        ?>
                        <img class="avatar insideinput" src="<?= $img ?>">
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group tg-inputwithicon">
                <label for="address1-input">PDF </label>
                <input type="file" class="form-control" name="document_pdf" accept="application/pdf">
            </div>
        </div>
    ...
    <?php 
    if(!empty($result['document_pdf'])):
    ?>
    <div class="row" style="height: 800px;">
        <div class="col-md-12">
            <div class="form-group tg-inputwithicon">
                <label for="address1-input">Available PDF </label>
                <embed src="<?= base_url('/uploads/').$result['document_pdf'];?>" name="embeded_doc" type="application/pdf" frameborder="0" width="100%" height="700px">
            </div>
        </div>
...
<?php endif;?>
    ...
    <div class="row">
        ...
        <button type="submit" style="margin:10px;" class="btn btn-primary btn-rounded create_new_next_button pull-right" id="create_new_record_btn" name="submit">Submit
        </button>
