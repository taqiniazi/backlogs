...
<div class="content container-fluid">
    ...
    <div class="col-sm-12">
        ...
        <div class="table-responsive">
            ...
            <form action="" method="POST" id="monthaly_task_checklist">
                ...
                <div class="year_data">
                    <?php $this->load->view('document_list/monthly_task_checklist_view_new'); ?>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).on('click', '.update_time_stainer', function() {
            ...
            var inputvalue = $(this).closest('.month-box').find('.timesheet_input').val();
            $(this).closest('.month-box').find('.timesheet_input').val(inputvalue + '  ' + datetime);
        ...
        $(document).on('submit', '#monthaly_task_checklist', function(e) {
            ...
            $.ajax({
                url: _base_url + 'Document_List/update_monthly_task_checklist_new',
                type: "POST",
                global: false,
                dataType: "json",
                data: form_data,
        ...
        function monthaly_task_checklist(e) {
            ...
            $.ajax({
                url: _base_url + 'Document_List/monthly_task_checklist_view_new',
                type: "POST",
                global: false,
                dataType: "json",
                data: dataJson,
