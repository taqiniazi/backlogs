...
<div class="">
    ...
    <div class="sec_title p_id form-group form-design-action">
        ...
        <div class="border-pd">
            ...
            <div class="row">
                    ...
                    <div class="form-outlay">
                        <div class="form-group dropdown">
                            ...
                            <select name="nonconformity" class="form-control" required>
                                ...
                                <option value="Product non-conformity" <?php if ($result['nonconformity'] == 'Product non-conformity' || !empty($ticketData)) echo 'selected'; ?>>Product non-conformity</option>
                ...
                <div class="col-md-12 design-form">
                    <div class="form-outlay">
                        <div class="form-group">
                            ...
                            <textarea rows="10" name="reference" class="form-control texteditor" placeholder="Documents used or referred-to (e.g. manuals, procedures, flowcharts, standards, records …)"><?= $ticketData['ticket_data'][0]['ticket_message']; ?><?= $result['reference']; ?></textarea>
                ...
                <div class="col-md-12 design-form">
                    <div class="form-outlay">
                        <div class="form-group">
                            <label class="heading">Non-Conformity</label>
                ...
                <div class="form-outlay">
                    <div class="form-group">
                        <label class="heading">Impact</label>
                            ...
                            <!-- <i class="lnr lnr-apartment"></i> -->
                            <textarea rows="10" name="impact" class="form-control texteditor" placeholder="State the impact of the non-conformity"><?= $result['impact'] ?></textarea>
            ...
            <div class="col-md-12 design-form">
                <div class="form-outlay">
                    <div class="form-group">
                        ...
                        <!-- <i class="lnr lnr-apartment"></i> -->
                        <textarea rows="10" name="investigation" class="form-control texteditor" placeholder="Cause of nonconformity: (investigation shall be conducted initially by staff identifying the nonconformity)"><?= $result['investigation'] ?></textarea>
                        <?php echo  form_error('name'); ?>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" name="correactive_checkboxes[]" type="checkbox">
                                    <label class="form-check-label">Invalid. Issue new NC</label>
                                </div>
                                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="implementation_corrective_checkbox[]">
                                    <label class="form-check-label">Not implemented. Issue new NC</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="implementation_corrective_checkbox[]">
        ...
        <div class="col-md-12 design-form">
            <div class="form-outlay">
                <div class="form-group">
                    <label class="heading">Vefirication of effectiveness of implemented corrective/preventive action:</label>
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="verification_corrective_checkbox[]">
                                    <label class="form-check-label">Not effective. Issue new NC</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="verification_corrective_checkbox[]">
                                    <label class="form-check-label">With Client</label>
