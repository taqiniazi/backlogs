    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input class="form-control" type="text" name='ticket_subject' id='ticket_subject' required
                   value='<?php echo $ticketData['ticket_data'][0]['ticket_subject']; ?>'>
        </div>
    </div>
        ...
        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 radio text-primary">
                    <label>
                        <input type="radio" name="ticket_priority"
                               value='normal' <?php echo ($ticketData['ticket_data'][0]['ticket_priority'] == 'normal') ? "checked" : ""; ?>>
                ...
                <div class="col-sm-4 radio text-warning">
                    <label>
                        <input type="radio" name="ticket_priority"
                               value='high' <?php echo ($ticketData['ticket_data'][0]['ticket_priority'] == 'high') ? "checked" : ""; ?>>
                        <strong>High</strong>
                ...
                <div class="col-sm-4 radio text-danger">
                    <label>
                        <input type="radio" name="ticket_priority"
                               value='critical' <?php echo ($ticketData['ticket_data'][0]['ticket_priority'] == 'critical') ? "checked" : ""; ?>>
    ...
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <input class="form-control" type="text" id='ticket_reference' name='ticket_reference'
                   value='<?php echo $ticketData['ticket_data'][0]['ticket_reference']; ?>'/>
                        ...
                        <div class="col-sm-6">
                            <div class="uploaded-box">
                                <div class="btn-group d-block">
                                    <button type="button"
                                            class="btn btn-light"> <?php echo $attachment['attachment_name']; ?></button>
                                    <button type="button" class="btn btn-light dropdown-toggle dropdown-toggle-split"
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                           href="<?php echo site_url('labEnquiries/deleteAttachment/' . $attachment['attachment_id']); ?>"
                                           onclick='javascript:if(!confirm("Are You Sure ?")){return false}'>DELETE</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input class="form-control" type="email" name='ticket_cc_to' id='ticket_cc_to'
                                       value='<?php echo $ticketData['ticket_data'][0]['ticket_cc_to']; ?>'/>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="ticket_reply_thru"
                                               value='pathhub' <?php echo ($ticketData['ticket_data'][0]['ticket_reply_thru'] == 'pathhub') ? "checked" : ""; ?>>
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="ticket_reply_thru"
                                               value='any' <?php echo ($ticketData['ticket_data'][0]['ticket_reply_thru'] == 'any') ? "checked" : ""; ?>>
                                        Reply can be
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="ticket_sms_alert"
                                               value='no' <?php echo ($ticketData['ticket_data'][0]['ticket_sms_alert'] == 'no') ? "checked" : ""; ?>>
                                        No
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="ticket_sms_alert"
                                               value='yes' <?php echo ($ticketData['ticket_data'][0]['ticket_sms_alert'] == 'yes') ? "checked" : ""; ?>>
                                        Yes
                                    </label>
                                </div>
                            </div>
