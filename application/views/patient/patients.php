...
.report_listing.patient_filters {
    position: absolute;
}

.patient_filters .tg-filterhold {
    position: relative;
    top: -10px;
    z-index: 999;
    padding: 10px 0px;
...
ul.tg-filters.record-list-filters{
    padding:0;
    margin: 0;
}

.tg-statusbar.tg-flagcolor.custome-flagcolors {
    padding: 5px;
}
...
<div class="report_listing patient_filters">
    <div class="row">
        <div class="col-md-12">
                ...
                <ul class="tg-filters record-list-filters">
                    ...
                    <li class="tg-statusbar tg-flagcolor custome-flagcolors">
                        <div class="tg-checkboxgroup tg-checkboxgroupvtwo">
                            ...
                            <span class="tg-radio tg-flagcolor4" title="Private">
                                <label for="private_patient" class="label_class" onclick="updateDatatable('private',this)">
                            ...
                            <span class="tg-radio tg-flagcolor4" title="Public">
                                
                                <label for="public_patient" class="label_class" onclick="updateDatatable('public',this)">
                            ...
                            <span class="tg-radio tg-flagcolor4" title="All">
                                
                                <label for="view_all" class="label_class" onclick="updateDatatable('view_all',this)">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title"><?= ($_GET['p'] && $_GET['e']) ? "Edit Patient" : 'New Patient'; ?></h3>
                    ...
                    <div id="exTab1" class="container">
                        ...
                        <div class="tab-content clearfix">
                            <div class="tab-pane active" id="1a">
                                <?php echo form_open_multipart('', array('id' => 'add-patient-form', 'class' => 'tg-formtheme tg-editform create_user_form')); ?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <fieldset>
                                                            ...
                                                            <div class="profile-img">
                                                                ...
                                                                <div class="tg-rightarea tg-useruploadimgholder">
                                                                    ...
                                                                    <div class="tg-useruploadimg">
                                                                        <img class="profile-pic img-fluid rounded-circle" id="patient-profile-pic" src="<?php echo ($_GET['p'] && $profile_picture_path) ? $profile_picture_path : base_url() . "assets/img/user.jpg"; ?>">
                                                                    </div>
                                                                </div>
                                                                <!-- profile image upload-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group tg-inputwithicon">
                                                        <label for="dob-input">Date of Birth<span class="red_dot"> *</span></label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group tg-inputwithicon">
                                                        <label for="Medicare Card Number">Hospital Status<span class="red_dot"> *</span></label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group tg-inputwithicon">
                                                        ...
                                                        <input type="text" name="suburb" id="suburb-input" value="<?php echo ($_GET['p'] && $patient['suburb'] != '') ? $patient['suburb'] : ""; ?>" class="form-control" placeholder="Suburb">
                                                    </div>
                                                </div>
                                                <!-- <div class="col-md-6">
                                                        <div class="form-group tg-inputwithicon">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group tg-inputwithicon">
                                                        ...
                                                        <input type="text" name="town" id="town-input" value="<?php echo ($_GET['p'] && $patient['town'] != '') ? $patient['town'] : ""; ?>" class="form-control" placeholder="State">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group tg-inputwithicon">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group tg-inputwithicon">
                                                        <input type="text" name="mobile" id="mobile-input" value="<?php echo ($_GET['p'] && $patient['mobile'] != '') ? $patient['mobile'] : ""; ?>" class="form-control" placeholder="Mobile Number" style="margin-top: 35px;">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="health_care_card_number" id="health_care_card_number-input" value="<?php echo ($_GET['p'] && $patient['health_care_card_number'] != '') ? $patient['health_care_card_number'] : "NA"; ?>" class="form-control" placeholder="Health Care Card Number">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="repat_health_care_card_number" id="repat_health_care_card_number-input" value="<?php echo ($_GET['p'] && $patient['repat_health_care_card_number'] != '') ? $patient['repat_health_care_card_number'] : "NA"; ?>" class="form-control" placeholder="Repatriation Health Care Card Number">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="home-input">Repatriation Pharmacy Benefits Card Number</label>
                                                <input type="text" name="repat_pharmacy_benefits_card" id="repat_pharmacy_benefits_card number-input" value="<?php echo ($_GET['p'] && $patient['repat_pharmacy_benefits_card'] != '') ? $patient['repat_pharmacy_benefits_card'] : "NA"; ?>" class="form-control" placeholder="Repatriation Pharmacy Benefits Card Number">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="seniors_health_care_card_number" id="seniors_health_care_card_number-input" value="<?php echo ($_GET['p'] && $patient['seniors_health_care_card_number'] != '') ? $patient['seniors_health_care_card_number'] : "NA"; ?>" class="form-control" placeholder="Seniors Health Care Card Number">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="home-input">Safety Net Entitlement Card Number</label>
                                                <input type="text" name="safety_net_entitlement_card_number_number" id="safety_net_entitlement_card_number-input" value="<?php echo ($_GET['p'] && $patient['safety_net_entitlement_card_number_number'] != '') ? $patient['safety_net_entitlement_card_number_number'] : "NA"; ?>" class="form-control" placeholder="Safety Net Entitlement Card Number">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="safety_net_concession_card_number" id="safety_net_concession_card_number-input" value="<?php echo ($_GET['p'] && $patient['safety_net_concession_card_number'] != '') ? $patient['safety_net_concession_card_number'] : "NA"; ?>" class="form-control" placeholder="Safety Net Concession Card Number">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="home-input">Service Number</label>
                                                <input type="text" name="service_number" id="service_number-input" value="<?php echo ($_GET['p'] && $patient['service_number'] != '') ? $patient['service_number'] : "NA"; ?>" class="form-control" placeholder="Service Number">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="religion" id="religion-input" value="<?php echo ($_GET['p'] && $patient['religion'] != '') ? $patient['religion'] : "NA"; ?>" class="form-control" placeholder="Religion">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="enter_by" class='form-control' id="entrer_by-input" value="<?php echo ($_GET['p'] && $patient['enter_by'] != '') ? $patient['enter_by'] : ""; ?>" required placeholder="Enter By">
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function updateDatatable(k,element){

        $(".label_class").removeClass("change_ui");
        element.classList.add("change_ui");
