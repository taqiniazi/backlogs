                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group tg-inputwithicon">
                                                            <i class="lnr lnr-user"></i>
                                                            <input type="text" name="mrn_number" id="mrn_number" value="" class="form-control" placeholder="MRN Number">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group tg-inputwithicon">
                                                            <i class="lnr lnr-user"></i>
                                                            <input type="text" name="other_name" id="other_name-input" value="" class="form-control" placeholder="Other Name">
                                                        </div>
                                                    </div>
                                                            </div>
                                                    <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group tg-inputwithicon">
                                                            <i class="lnr lnr-user"></i>
                                                            <input type="text" name="nick_name" id="nick_name-input" value="" class="form-control" placeholder="Nick Name">
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="home" id="home-input" value="" class="form-control" placeholder="Home Contact Number">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group tg-inputwithicon">
                                                            <i class="lnr lnr-apartment"></i>
                                                            <input type="text" name="business_contact" id="business_contact-input" value="" class="form-control" placeholder="Business Contact Number">
                                                        </div>
                                                    </div>                                                    
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group tg-inputwithicon">
                                                            <i class="lnr lnr-apartment"></i>
                                                            <input type="text" name="other" id="other-input" value="" class="form-control" placeholder="Other Contact Number">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group tg-inputwithicon">
                                                            <i class="lnr lnr-map-marker"></i>
                                                            <input type="text" name="fax" id="fax-input" value="" class="form-control" placeholder="Fax">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="health_fund_code" id="health_fund_code-input" value="" class="form-control" placeholder="Health Fund Code" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="home-input">Issue Date</label>
                                                <input type="date" name="issue_date" id="issue_date-input" value="" class="form-control" placeholder="Issue Date">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="policy_number" id="policy_number-input" value="" class="form-control" placeholder="Policy Number">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="home-input">UPI</label>
                                                <input type="text" name="upi" id="upi-input" value="" class="form-control" placeholder="UPI">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="home-input">Expiry Date</label>
                                                <input type="date" name="expiry_date" id="expiry-input" value="" class="form-control" placeholder="Expiry Date">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="health_fund_name" id="health_fund_name-input" value="" class="form-control" placeholder="Health Fund Name">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="home-input">Alias Surname</label>
                                                <input type="text" name="alias_surname" id="alias_surname-input" value="" class="form-control" placeholder="Alias Surname">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="home-input">Alias Given Name</label>
                                                <input type="text" name="alias_name" id="alias_surname-input" value="" class="form-control" placeholder="Alias Given Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="pensioner_card_number" id="pensioner_card_number-input" value="" class="form-control" placeholder="Pensioner Card Number" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="home-input">Health Care Card Number</label>
                                                <input type="text" name="health_care_card_number" id="health_care_card_number-input" value="" class="form-control" placeholder="Health Care Card Number">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="repat_health_care_card_number" id="repat_health_care_card_number-input" value="" class="form-control" placeholder="Repat Health Care Card Number">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="home-input">Repat Pharmacy Benefits Card Number</label>
                                                <input type="text" name="repat_pharmacy_benefits_card" id="repat_pharmacy_benefits_card number-input" value="" class="form-control" placeholder="Repat Pharmacy Benefits Card Number">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="seniors_health_care_card_number" id="seniors_health_care_card_number-input" value="" class="form-control" placeholder="Seniors Health Care Card Number">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="home-input">Safety Net Entitlement Card Number</label>
                                                <input type="text" name="safety_net_entitlement_card_number_number" id="safety_net_entitlement_card_number-input" value="" class="form-control" placeholder="Safety Net Entitlement Card Number">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="safety_net_concession_card_number" id="safety_net_concession_card_number-input" value="" class="form-control" placeholder="Safety Net Concession Card Number">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="home-input">Service Number</label>
                                                <input type="text" name="service_number" id="service_number-input" value="" class="form-control" placeholder="Service Number">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="religion" id="religion-input" value="" class="form-control" placeholder="Religion">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="my_health_record_number" id="my_health_record_number-input" value="" class="form-control" placeholder="My Health Record Number" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="home-input">My Health Record Consent Withdrawn</label>
                                                <input type="text" name="my_health_record_consent_withdrawn" id="health_care_card_number-input" value="" class="form-control" placeholder="My Health Record Consent Withdrawn">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="health_data_respository" id="repat_health_care_card_number-input" value="" class="form-control" placeholder="Health Data Respository">
                                            </div>
                                        </div>                                        
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="">
                                                ...
                                                <input type="checkbox" name="deceased" id="deceased-input" value="1" required><span style="color: #000;">&nbsp;Deceased</span>
                                            </div>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="form-group">
                                                <input type="checkbox" name="in_active" id="active-input" value="1" class="" required><span style="color: #000;">&nbsp;In Active</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="enter_by" class='form-control' id="entrer_by-input" value="" required placeholder="Enter By">
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    var p_id = "<?php if($_GET['p']) echo $this->input->get('p'); else echo 0; ?>";
    var step = "<?php if($_GET['step']) echo $this->input->get('step'); else echo 1; ?>";
