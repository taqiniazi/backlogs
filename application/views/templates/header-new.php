...
<head>
    <meta charset="utf-8">
    <meta name="description" content="Digital Pathology LIMS Software">
    ...
    ?>
    <link type="text/css" rel="stylesheet" href="<?php echo base_url(); ?>assets/<?php echo $value; ?>" />
    <?php
    }
    }
    ?>
    ...
    $(document).ready(function () {
        $(".custom_hospital_container > div:nth-child(2)").after("<div title='See More' class='hospital-info ml-1'><a href='<?php echo base_url() ?>auth/edit_user/<?php echo  $this->ion_auth->user()->row()->id ?>' class='d-block'><i class='fa fa-plus'></i></a></div>");
    })
</script>
</head>
