...
#further_work_table_requested_length, .dataTables_wrapper div.dataTables_filter {
    position: relative;
}
}
                ...
                <div class="tg-filterhold">
                    <ul class="tg-filters record-list-filters">
                       ...
                       <!--  <li class="tg-flagcolor" style="padding: 3px 8px">
                        ...
                        <li class="tg-statusbar tg-flagcolor custome-flagcolors">
                            <select id="lab_status2232" onChange="javascript:window.location.href ='https://pathhub.fnqhpathology.com/index.php/doctor/view_further_work?fw_page='+this.value">
                                    <option value="">Select Lab Status</option>
                                    <option value="complete" <?php if($_GET['lab_status'] == 'complete') echo 'selected'; ?>>Completed</option>
                                    <option value="requested" <?php if($_GET['lab_status'] == 'requested') echo 'selected'; ?>>Requested</option>
                            </select>
                        </li>
        ...
        <table id="further_work_table_requested" class="table table-stripped custom-table">
            <thead>
                <tr>
                    ...
                    <th style="text-align:center">Request Comment</th>
                ...
                foreach ($requested as $row) 
				{
                    ...
                    <tr>
                        ...
                        <td><?= (!empty($row->lab_number) ? $row->lab_number : 'N/A'); ?></td>
                         <td><?=($row->block_id == 0) ? "": $row->further_block_no; ?></td>
                    		<td><?= (!empty($row->test_name)) ? $row->test_name : ''; ?></td>
                        ...
                        <?php
                                ...
                                $decryptedDetails = $this->Userextramodel->getUserDecryptedDetailsByid($row->id);
                        ...
                        <td style="text-align: center;">
                            <select class="change_further_status" data-rid="<?php echo $row->fw_id; ?>">
                                <option value="">--Select Status--</option>
                                <option value="complete" <?php print ($row->further_status == 'complete') ? "selected" : "";?>>Completed</option>
                                <option value="requested" <?php print ($row->further_status == 'requested') ? "selected" : "";?>>Requested</option>
                            </select>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Print Cassette/Slide</h5>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('change', '#lab_status',function(){
            ...
            url.searchParams.set("fw_page", status); 
            var newUrl = url.href;
