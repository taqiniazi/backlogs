                ...
                <div class="modal-body">
                    <div id=''>
                            ...
                            <input type="hidden" name='<?= $ci->security->get_csrf_token_name(); ?>' value='<?= $ci->security->get_csrf_hash(); ?>'>
                                ...
                                <a href="javascript:print_barcode();" id="btn_barcode" class="btn btn-primary">Multi-label</a>
