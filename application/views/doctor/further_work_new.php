...
<div class="page-header">
    <div class="row align-items-center">
        ...
        <a class="btn btn-primary print_button" href="<?php echo base_url('/doctor/doctor_record_detail_old/') . $recordDetails[0]["uralensis_request_id"]; ?>">Back</a>
    </div>
</div>
<div class="row">
<?php
...
<input type="hidden" id="num_of_levels" name="levels" value="1" />
<input type="hidden" id="group_id" name="group_id" value="<?php echo $recordDetails[0]["lab_id"]; ?>" />
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12 form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-4 form-group hide">
                            <select class="form-control select2" id="myInput4" name="specimen_id" 
                            >
                                <?php 
...
//echo $alphabet[3]; // returns D
                        ...
                        <div class="col-lg-2 form-group nopadding" style="display:none">
                        ...
                        <input type="text" name="pci_number" style="display:none" id="pci_number" value="<?php echo $recordDetails[0]["pci_number"]; ?>" readonly="readonly" class="form-control" placeholder="Digi No">
                        
                            <select class="form-control select2" name="block_no" id="blockSelections1" style="display:none">
                                <option value="1A">1A</option>
                                <option value="1B">1C</option>
...
<!--                        <div class="col-lg-5 form-group">
                ...
                <?php 
                // echo "<pre>";
                // print_r($test_sub_categories["main_cat"]);die;
                ?>
...
$(document).ready(function () {
   ...
   $('#myInputBlock').select2({
    ...
    $(document).on('change', '#myInput4',function(){
        document.getElementById('blockcount').value=1;
        var specimentId = $(this).val();
        $('#testids option').hide();
        $('#testids option[data-default="1"]').show();
        $('#testids option[data-default="1"]').attr('selected', 'selected');
        $('#testids option[data-sno="'+specimentId+'"]').show();
        $('#testids option').each(function () {
