...
// require_once('application/views/doctor/inc/snomed/snomed-m-code.php');
   ...
   // $group_row = $this->ion_auth->get_users_main_groups()->row()->group_type;
    ...
    <div class="modal fade" id="barcode_custom_action" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Barcode Type</h5>
                ...
                <div class="modal-body" style="padding:15px 0px !important;">
                    <div id=''>
                            ...
                            <a href="#" id="downloadFile" style="display: none;" download="barcode.txt"></a><br/>
                            <input type="hidden" name='<?= $ci->security->get_csrf_token_name(); ?>' value='<?= $ci->security->get_csrf_hash(); ?>'>
                                <input type="hidden" name="request_id[]" value="<?php echo $request_query[0]->barcodeInfo->rq_id;?>" class="br_data_input">
                                <input type="hidden" name="lab_id[]" value="<?php echo $request_query[0]->barcodeInfo->lab_id;?>" class="br_data_input">
                                <input type="hidden" name="lab_number[]" value="<?php echo $request_query[0]->barcodeInfo->lab_no;?>" class="br_data_input">
                                <input type="hidden" name="digi_number[]" value="<?php echo $request_query[0]->barcodeInfo->lims_no;?>" class="br_data_input">
                                <input type="hidden" name="test_id[]" value="<?php echo $request_query[0]->barcodeInfo->all_test_id;?>" class="br_data_input">
                                <input type="hidden" name="test[]" value="<?php echo $request_query[0]->barcodeInfo->test;?>" class="br_data_input">
                                <input type="hidden" name="patient_id[]" value="<?php echo $request_query[0]->barcodeInfo->patient_id;?>" class="br_data_input">
                                <input type="hidden" name="hospital_id[]" value="<?php echo $request_query[0]->barcodeInfo->hospital_id;?>" class="br_data_input">
                                <input type="hidden" name="patient_name[]" value="<?php echo $request_query[0]->barcodeInfo->patient;?>" class="br_data_input">
                                <input type="hidden" name="specimen_id[]" value="<?php echo $request_query[0]->barcodeInfo->sp_id;?>" class="br_data_input">
                                <input type="hidden" name="b_img" value="" class="request_b_img">
                                <input type="hidden" name="print_action_type" value="" id="print_action_type">
                               <input type="hidden" name="action_type" value="" id="action_type">
                                <center class='center_class'>
                                <a href="javascript:barcode_p(this,1);" data-type="1" id="btn_barcode" class="btn btn-info">Request</a>
                                <a href="javascript:barcode_p(this,2);" data-type="2" id="btn_sp_pot" class="btn btn-info">Pot</a>
                               
                                
                              <a href="javascript:void(0);" onclick="download_request_barcode(this,2)" id="btn_download_request" class="btn btn-info" data-values="<?php echo $request_query[0]->barcodeInfo->lab_no.",".$request_query[0]->barcodeInfo->pSurname ?>" data-blocks="<?php echo $request_query[0]->barcodeInfo->block_no_list;?>" data-tests="<?php echo $request_query[0]->barcodeInfo->test;?>">Cassette</a>
                              <a href="javascript:void(0)" onclick="download_request_barcode(this,1)" id="btn_download_request" class="btn btn-info" data-values="<?php echo $request_query[0]->barcodeInfo->lab_no.",".$request_query[0]->barcodeInfo->pSurname ?>" data-blocks="<?php echo $request_query[0]->barcodeInfo->block_no_list;?>" data-tests="<?php echo $request_query[0]->barcodeInfo->test;?>">Slide</a>
                               <!-- <a href="javascript:void(0);" onclick="download_request_barcode(this,2)" id="btn_download_request1" class="btn btn-info" data-values="<?php echo $request_query[0]->barcodeInfo->lab_no.",".$request_query[0]->barcodeInfo->pSurname ?>" data-blocks="<?php echo $request_query[0]->barcodeInfo->block_no_list;?>" data-tests="<?php echo $request_query[0]->barcodeInfo->test;?>">Cassette</a>
                                 <a href="javascript:barcode_p(this,2);" data-value="" id="btn_sp_request" data-type="2" class="btn btn-info">Request</a> -->
...
<?php
if ($request_query[0]->specimen_publish_status == 1) $disableDiv = "style=pointer-events:none;opacity:0.8;";
else $disableDiv = " ";
 ?>
...
<?php
if ($request_query[0]->specimen_publish_status == 1) $disableDiv1 = "display:none";
else $disableDiv1 = " ";
 ?>       

        <div class="delete_add_specimen" style="margin-top: 10px; <?=$disableDiv1?>">
        ...
        <div class="modal fade" id="add_specimen_modal" tabindex="-1" role="dialog" aria-hidden="true"
            ...
            <div class="tg-modaldialog modal-dialog" role="document" style="width:400px">
                ...
                <div class="tg-modalbody modal-body">
                    ...
                    No Of Specimen:
                        ...
                        <div class="form-group" style="display:none">
                            <textarea id="clinical_history" name="specimen_clinical_history" placeholder="Specimen Clinical History"></textarea>
                        </div>
                        <div class="form-group" style="display:none">
                            <textarea id="comment_history" name="specimen_comment_history" placeholder="Specimen Comment History"></textarea>
                        </div>
                        <div class="form-group" style="display:none">
        ...
        <div class="modal fade" id="add_block_modal" tabindex="-1" role="dialog" aria-hidden="true"
             data-backdrop="static">
            <div class="tg-modaldialog modal-dialog" role="document" style="width:500px">
                <div class="tg-modalhead">
                    <a href="javascript:void(0);" class="fa fa-close tg-btnclose" data-dismiss="modal"
                       aria-label="Close"></a>
                ...
                <div class="tg-modalbody modal-body">
                    ...
                    <div class="row blocks_wrapper" id="blocks_check">
                        ...
                        <div class="col-md-2 padding-bottom" style="display:none">
                            <div class="form-group form-focus">
                        ...
                        <div class="col-md-4 padding-bottom" style="display:none">
                                            ...
                                            for ($i = 1; $i <= $specimen_total_count; $i++) {
                                                ...
                                                if ($i === $inner_tab_count) {
                                                    ...
                                                    <div class="form-group form-group-tiny"
                                                        ...
                                                        <textarea id="tg-tinymceeditorcommennt_<?php echo intval($i); ?>" name="specimen_comment_history"
                                                                  class="tg-tinymceeditor dusrd editor_comment_history_<?php echo intval($i); ?>"><?php echo $row->specimen_comment_history; ?></textarea>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 form-group tg-inputicon tg-disabled-form-group"
                                                        ...
                                                        <label style="visibility: hidden;">No label</label>
                                                        <textarea
                                                            class=" form-control dusrd editor_comment_history_<?php echo intval($i); ?>"
                                                            placeholder="<?php echo @strip_tags($specimen_query[$j]->specimen_comment_history); ?>"></textarea>
                                                    </div>
                                                    <?php
                                                }
                                                ?>
                                ...
                                <div class="card-body">
                                    <fieldset class="tg-tabfieldsettwo">
                                                    ...
                                                    <button type="button" class="btn btn-info block_model_btn_<?php echo $inner_tab_count; ?>"
                                                            ...
                                                            <button class="btn btn-info printBarcode" type="button" style="float: right;margin-right: 20px;margin-top: 10px;" data-toggle="modal" data-target="#barcode_custom_action">Print Barcode</button>
                                                                ...
                                                                if ($sp_block->specimen_id == $row->specimen_id) {
                                                                    ...
                                                                    <tr>
                                                                       ...
                                                                       <!-- <td><?php $test = "H&E"; if($sp_block->name!='') { echo $test =$sp_block->name; } else { print "H&E";} ?></td> -->
                                                                        <td>
                                                                        <select multiple name="test_ids[]" data-id="<?= $sp_block->id; ?>" data-sid="<?php echo $sp_block->specimen_id; ?>" data-sno="<?php echo $sp_block->specimen_no; ?>" data-bno="<?php echo $sp_block->block_no; ?>" id="blocks_<?php echo $sp_block->id; ?>" placeholder="Test" class="test_wrap test-list form-control select2">
                                                                                <?php 
                                                                                    $temp = 0;
...
<!--                                                                        <td>--><?php echo $sp_block->description; ?><!--</td>-->
                                                                        ...
                                                                        $parameters['dropdownSelector'] = 'blocks_'.$sp_block->id;
                                                                        $param = '';
                                                                        ...
                                                                        <a data-count="<?php echo $count_speciment_block_tem; ?>" data-cnt = "<?php echo $cnt; ?>" href="javascript:void(0);" data-sno="<?php echo $sp_block->specimen_no; ?>" data-href="<?php echo site_url() . '/doctor/delete_multiple_test/' . urlencode($sp_block->test_ids) .'/'. $record_id; ?>" title="Remove this test." class="delete_test"><strong><i class="fa-2x fa fa-trash-o m-r-5"></i></strong></a></td>
                                                                        <?php } ?>
                                                                    </tr>
                                                                    <?php
                                                                }
                        ...
                        <div class="col-md-12 nopadding form-group" style="display:none">
                            <div class="sec_title form-group">
                                Block/Specimen Type
                        ...
                        // echo "<pre>";
                        // print_r($row);die;
                        if (get_ds_status($CI->uri->segment(3)) == 0) { ?>
                            <div class="col-md-12 nopadding" <?=$disableDiv?>>
                                <div class="sec_title form-group">
                        ...
                        <div class="col-md-12 nopadding" <?=$disableDiv?>>
                            ...
                            <div class="card hidden show">
                                <div class="card-body" <?=$disableDiv?>>


                                    <div class="tg-tabfieldsetfourhold" <?=$disableDiv?>>
                                        <fieldset class="tg-tabfieldsetfour">
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="form-group tg-formgroupcheck halfform-group" style="display:none">
                                                        ...
                                                        <div class="d-flex flex-column comment-section">
                                                            <div class="bg-light p-2">
                                                                ...
                                                                <div class="mt-2 text-right" style="margin-top: 15px;">
                                                                    <button class="btn btn-primary btn-sm shadow-none post_comment_btn2" type="button">Post comment
                                                                    </button>
                            ...
                            <div class="card hidden show">
                                <div class="card-body">
                                    <fieldset class="tg-tabfieldsettwo">
                                        ...
                                        <?php $k=0; foreach ($specimen_query as $key1=>$row1) { $k++; ?>
                                            <input type="hidden" name="specimen_list_id[]" value="<?= $row1->specimen_id; ?>" />
                                            <?php if($row1->specimen_id != $row->specimen_id){ continue; } ?>
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <strong>Billing Code</strong>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <select multiple name="bill_code[<?=$row1->specimen_id; ?>][]" class="form-control dusrd2 select2" data-live-search="true">
                                            ...
                                            <?php foreach($row->request as $reqRow){ $row2 = (object) $reqRow; if(!empty($row2->bill_code_text)) { ?>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-1">
                                                         <a href="javascript:void(0);" class="delete_billing" data-url="<?= base_url("laboratory/delete_billing_by_request/$row2->id/$row2->request_id"); ?>" style="font-size:27px;"><i class="fa fa-trash"></i></a> 
                                                    </div>
                                                </div>
                                            <?php } }  ?>
                                        <?php } ?>
                            ...
                            <div class="col-md-12">
                              ...
                              <input type="hidden" name="lab_id" id="lab_id" value="<?=$labId?>"></div>
                                        ...
                                        <?php if($request_query[0]->urole != 'Pathologist') {?>
                                            <button style="margin:10px;" class="btn btn-primary btn-rounded create_new_next_button pull-right"
                    ...
                    <div id="sendprivatemessage" class="modal fade" role="dialog" <?=$disableDiv?>>
                        <div class="modal-dialog">
                            <!-- Modal content-->
                            <div class="modal-content">
                                <div class="modal-header">
...
<script>
					$('#create_new_record_btn').on('click', function (e) 
	{
        ...
        $.ajax({
                url: _base_url + '/doctor/getRequestInfo',
                type: 'POST',
                global: false,
                dataType: 'json',
                data: {
                    'requeststatus': $('#changeStatus').val(),
                    ...
                    if(data.status === 'success'){
                        setTimeout(function(){
                            ...
                            if (origin == 'http://localhost') {
                                url = origin + '/fnqhpathology/doctor/doctor_record_detail_old/' +data.request_id;
                            } else {
                                url = origin + '/doctor/doctor_record_detail_old/' +data.request_id;
                            }
                            window.location.href = url;
                        },1000);
                    }else{
                        jQuery.sticky('No request found with same status.', {classList: 'important', speed: 200, autoclose: 7000});
                    }
                },
                error: function (err) {
            ...
            // });
                    ...
                    <script>
                        ...
                        function save_specimen_data(){
                                ...
                                let contentDatacomment = tinymce.get("tg-tinymceeditorcommennt").getContent();
                                tinymce.get("tg-tinymceeditorcommennt_"+selected_specimen).setContent(contentDatacomment);
                                //jQuery(document).find('#tg-tinymceeditor_1').text(contentData);
                        ...
                        jQuery(document).ready(function () {
                            ...
                            $(document).on('change','.test_wrap_billing_code',function(e){
                                e.stopImmediatePropagation();
                                testBlock = {
                                    'billing_code_ids' : $(this).val(),
                                    'request_id': $('#record_id').val(),
                                    [csrf_name]: csrf_hash
                                }
                                jQuery.ajax({
                                    type: "POST",
                                    url: '<?php echo base_url('index.php/doctor/editBillingCode'); ?>',
                                    data: testBlock,
                                    dataType: "json",
                                    success: function (response) {
                            ...
                            $(document).on('change', '.specimen_snomed_t1_<?php echo $inner_tab_count; ?>', function () {
                                var _this = jQuery(this);
                                jQuery('#doctor_update_specimen_record_<?php echo $inner_tab_count; ?> input[name=specimen_diagnosis]').attr('data-overwrite', 'true');
                           ...
                           $(document).on('change', '.specimen_snomed_t2_<?php echo $inner_tab_count; ?>', function () {
                            ...
                            jQuery('#doctor_update_specimen_record_<?php echo $inner_tab_count; ?> input[name=specimen_diagnosis]').bind('keyup change', function () {
                                var _this = jQuery(this);
                                _this.attr('data-overwrite', 'false');
                            });
                            ...
                            jQuery('.ds_click').unbind().on('click', function (e) {
                                ...
                                if(jQuery(this).hasClass('active')){
                                    ...
                                    var myContent1 = tinymce.get("tg-tinymceeditor").getContent();
                                    ...
                                    tinymce.get("tg-tinymceeditor").setContent(myContent1);
                            ...
                            jQuery('.update_specimen_record_btn').click(function(e){
                                ...
                                var origin = window.location.origin;
                                if (origin == 'http://localhost') {
                                    url = origin + '/fnqhpathology/doctor/doctor_record_detail_old/' +$('#record_id').val() + '?stab='+ selected_specimen;
                                } else {
 ...
 setTimeout(function(){ 
                                ...
                                if (_this.find('.specimen_dignosis_<?php echo $inner_tab_count; ?>').attr('data-overwrite') == 'true') {
                                    ...
                                    success: function (response) {
                                        if (response.type === 'success') {
                                            ...
                                            window.setTimeout(function () {
                                                ...
                                                // var origin = window.location.origin;
                                                // if (origin == 'http://localhost') {
                                                //     url = origin + '/fnqhpathology/doctor/doctor_record_detail_old/' +$('#record_id').val() + '?stab='+ <?php echo $inner_tab_count; ?>;
                                                // } else {
                                                //     url = origin + '/doctor/doctor_record_detail_old/' +$('#record_id').val() + '?stab='+ + <?php echo $inner_tab_count; ?>;
                                                // }
                                                // window.location.href = url;
        ...
        <div class="col-md-12 nopadding" <?=$disableDiv?>>
            <div class="sec_title form-group">
                Comment <a href="javascript:void(0);" class="checv_up_down"><i class="fa fa-chevron-up"></i></a>
            </div>
            <div class="card hidden show">
                <div class="card-body">
                    <fieldset class="tg-tabfieldsettwo">
                        <div class="form-group form-group-tiny" style="width:100% !important;">
                            ...
                            <textarea id="tg-tinymceeditorcommennt" name="comment_history" class="tg-tinymceeditor dusrd3 editor_comment_history"><?php echo $specimen_query[0]->specimen_comment_history; ?></textarea>
                        </div>
                    </fieldset>
                </div>
            </div>
        ...
        <div class="col-md-12 nopadding" <?=$disableDiv?>>
            <div class="sec_title form-group">
            Billing <a href="javascript:void(0);" class="checv_up_down"><i class="fa fa-chevron-up"></i></a>
            </div>
            <div class="card hidden show">
                <div class="card-body">
                    <fieldset class="tg-tabfieldsettwo">
                        <div class="form-group form-group-tiny" style="width:100% !important;">
                            <label>Billing </label>
                            <select multiple name="billing_code_ids[]" placeholder="Billing Code" class="test_wrap_billing_code test-list_billing_vode form-control select2">
                                <?php
                                    // $addedIds = array_column($row->request, 'bill_code');
                                    foreach ($specimen_query[0]->bill_code_arr as $bData){
                                        $billingselected = '';
                                        if($specimen_query[0]->billing_code_ids != ''){
                                            $billingCode = explode(",", $specimen_query[0]->billing_code_ids);    
                                            if(in_array($bData['id'], $billingCode)){
                                                $billingselected = "selected";
                                            }
                                        }
                                ?>
                                    <option value="<?=$bData['id']; ?>" <?php echo $billingselected; ?>><?= $bData['bill_code']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </fieldset>
