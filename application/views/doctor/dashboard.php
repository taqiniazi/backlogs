...
<style>
    ...
    /*#DataTables_Table_2_wrapper .row:last-child{
    	margin-right: 0;
    	margin-left: 0;
    	padding: 0 15px;
    }*/
    ...
    .page-header .breadcrumb li{
        font-weight: 300;
        font: 300 16px/24px 'CircularStd1', sans-serif !important;
    }
    span.dn{display: none !important;}
    span.avatar:hover span.dn{
    ...
    .dash_tabs .nav-tabs.nav-tabs-solid > li{width: calc(100%/4);}
				...
				<div class="card-body dash_tabs nopadding new_height">
					...
					<div class="tab-content">
						...
						<div class="tab-pane active" id="work_list">
							...
							<div class="col-md-12 sub_tab_title" style="text-align: left">In Progress Cases</div>
							<div class="clearfix"></div>
							

							<div class="table-responsive form-group">
                                <table class="table doctors_pub_upub_table table custom-table table-hover mb-0" style="width: 100% !important">
                                    <thead>
                                    <tr>
                                        <!-- <th>Date </th>
                                        <th>SubSpecialty</th> -->
									...
									//print count($unpublished_stats)
									 if(!empty($unpublished_stats))
									{
										
										
										
                                        $scanned = $not_scanned = $urgent_usc =0; $urgent_sc =0; $tww_usc =0; $tww_sc =0; $routine_usc=0; $routine_sc=0; $spec_total_usc=0; $spec_total_sc=0;
                                        foreach ($unpublished_stats as $row)
                                        {   
                                            $not_scanned = $not_scanned + $row['not_scanned'];
                                            $scanned = $scanned+ $row['scanned'];
                                            ?>
                                            <tr>                                                
                                                <td><?php echo $row['hospital']; ?></td>                                                
                                                <td class=" text-center font-20 font-md-16">
                                                	 <button class="btn_bl"><?php echo $row['not_scanned']; ?></button>
                                                </td>
                                                <td class="text-success text-center font-20 font-md-16">
                                <!--                    <button class="btn_gre" onclick="goto_record_list('<?php echo $row['hospital']; ?>')"><?php echo $row['scanned']; ?></button>-->
                                              <a class="btn_gre" style="padding:5px;" href="<?php echo base_url()?>/doctor/doctor_record_list"><?php echo $row['scanned']; ?></a>
                                                </td>
                                            </tr>
                                            <?php 
                                        } ?>
                                        <tr>                                            
                                            <td>Total</td>
                                            <td class='text-center'><?= $not_scanned; ?></td>
                                            <td class='text-center'><?= $scanned; ?></td>                                            
                                        </tr>
                                        <?php 
                                        /*foreach ($unpublished_stats as $row)
										{
                                            ...
                                            <!-- <tr>
                                                ...
                                                <td><?php echo @mb_substr($row['hospital'],0,-1); ?></td>
                                                ...
                                                <td class="text-success text-center font-20 font-md-16">
                                                    <form action="<?php echo base_url('institute/doctor_record_list'); ?>" method="post">
                                        ...
                                        <!-- <tr>
                                            ...
                                            <td>Total</td>
                                            <td>All</td>
                                            --<td class="text-black text-center font-20 font-md-16"><?php //echo $urgent_usc; ?></td>
                                            <td class="text-success text-center font-20 font-md-16"><?php //echo $urgent_sc; ?></td>-->
                                            <!-- <td class="text-black text-center font-20 font-md-16"><?php //echo $tww_usc; ?></td>
                                            <td class="text-success text-center font-20 font-md-16"><?php //echo $tww_sc; ?></td> -->
                                            <!--<td class="mobile_hidden_table_cell text-black text-center font-20 font-md-16"><?php //echo $routine_usc; ?></td>-->
                                            <!--<td class="mobile_hidden_table_cell text-success text-center font-20 font-md-16"><?php //echo $routine_sc; ?></td>--
                                            <td class="text-black text-center font-20 font-md-16"><button style="background: transparent; border: 1px solid;" ><?php echo $spec_total_usc; ?></button></td>
                                            <td class="text-success text-center font-20 font-md-16">
                                                <button style="background: transparent; border: 1px solid;" ><a class="text-success" href="<?php echo base_url('institute/doctor_record_list'); ?>"><?php echo $spec_total_sc; ?></a></button>
                                            </td>
                                        </tr> -->
                                    <?php } ?>
							...
							<div class="sub_tab_title col-md-12"  style="text-align: left">
                                Authorised Cases
							...
							<div class="table-responsive form-group">
								<table class="doctors_pub_table table custom-table table-hover mb-0">
									<thead>
										<tr>
											<th>Date Period</th>
											<th>Sub Specialty</th>
						...
						<div class="tab-pane" id="twenty_thirty">
                            <div class="table-responsive" style="">
                                <table class=" doctors_tat_table table custom-table table-hover mb-0">
                                    <thead>
                                    <tr>
                                        <th>UL No. <br> Track No.</th>
                                        <th>Client <br> Clinic</th>
                                        <!-- <th>Courier No. <br> Batch No</th> -->
                                        <th>Patient First Name<br> Last Name</th>
                                        <th>NHS No.<br>DOB</th>
						...
						<div class="tab-pane" id="thirty_plus">
                            ...
                            <table class="doctors_tat_table table custom-table table-hover mb-0">
                                ...
                                <tr>
                                    ...
                                    <th>Client <br> Clinic</th>
                                    <!-- <th>Courier No. <br> Batch No</th> -->
                                    <th>Patients First Name<br> Last Name</th>
                                    <th>NHS No.<br>DOB</th>
                                    <th>Digi No.<br>Rel Date</th>
                                    <th> Flag</th>
                                    <th>Tat</th>
                                ...
                                <div class="active_list_sub_title">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-sm-8">
                                            <span>RCVS No: <?php echo $cv_appr_data['gmc_no'] ?></span>
...
<!--                                                    --><?php //} ?>
                                                <span class="dn"><?php echo $row->doctor_name; ?></span>
                                            </span>
											<!-- <a href="javascript:void(0)"><?php echo $row->doctor_name; ?></a> -->
										</h2><br />
                                        
									</td>
									<td><?php echo $row->hospital_name; ?><br /><?php echo $row->email; ?></td>
									<td></td>
									<!--<td>
										<div class="dropdown action-label">
...
<!--										</td>-->
    ...
    <div class="col-md-12 d-flex">
            <div class="card card-table flex-fill">
                <div class="card-header">
                        ...
                        <div class="col-md-6">
                            <h3 class="card-title mb-0  pull-right"><a href="javascript:get_weekly_request(-1)"><strong>&lt;</strong></a> <span id="weekly_static" title="2022-6-22 To 2022-6-29">Weekly Static </span><a href="javascript:get_weekly_request(1)"><strong>&gt;</strong></a></h3>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                <div class="card-body" style="max-height:330px; min-height: 200px; overflow-y:auto; padding: 0 10px;">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover custom-table table-borderd">
                            <thead>
                                <tr>
                                    <th>Pathologist</th>
                                    <th>Date</th>
                            ...
                            <tbody id="weekly_request">
                                <tr>
                                    <td colspan='5' class=''><i class='fa fa-refresh fa-spin'></i> Loading...</td>
                                </tr></tbody>
                        </table>
                    </div>
                </div>                
	...
	<div class="row">
		<div class="col-md-6 d-flex">
			<div class="card card-table flex-fill" style="">
				
				<div class="card-body dash_tabs nopadding" style="">
                                                            ...
                                                            <td class="text-right">
                                                                ...
                                                                <div class="dropdown dropdown-action">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right" style="width: 100px;">
                                                                        ...
                                                                        <a class="dropdown-item" href="<?= base_url('doctor/download_forms/'.$row->file_name); ?>" ><i class="fa fa-cloud-download m-r-5"></i>Download</a>
                                                                        <a class="dropdown-item" href="<?= base_url('doctor/delete_upload_docs/'.$row->id); ?>" ><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                                    </div>
                                                                </div>
                                                                <?php } ?>
                                                            </td>
		...
		<div class="col-md-6 d-flex">
			<div class="card card-table flex-fill" style="height: 448px; overflow-y: hide; border: 0;">
				<div class="card-header">
				...
				<!--<div class="card-body">
                    <div class="card-body">
                        <div class="">
                            <table class="table custom-table table-hover request_form_table mb-0" id="request_form_table">
                                <thead>
                                <tr>
                                    <th>File</th>
                                    <th>Case Record</th>
...
/*                                    }
	...
	<div class="row">
		<div class="col-md-3 d-flex" style="display: none !important;">
...
<!--		</div>-->
        ...
        <div class="col-md-6 col-lg-8 col-xl-8 d-flex">
            <div class="card card-table flex-fill">
                <div class="card-header">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover custom-table mb-0">
                            ...
                            <?php foreach ($usersLogins as $uDetail){?>
                                ...
                                ?>
                                <tr onClick="(function(){
                                    window.location = '<?php echo base_url()."/doctor/";?>getLoginDetail/<?php echo $user_detail;?>';
                                    return false;
                                    })();return false;">
                                    <td>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height: 700px;">
                <?php echo form_open_multipart('doctor/upload_docs_form', array('id' => 'upload_sop_form', 'name' => 'upload_sop_form')); ?>
                ...
                <div class="row">
                    ...
                    <div id="trainee_fields" style="display:<?php echo $display; ?>;">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <div class="form-group">
                                <div class="cal-icon">
                                    <input class="form-control floating date_range drop_up" name="train_period" type="text" value="<?php echo ($cv_appr_data['trainee_period_start']!=''?date('Y/m/d', strtotime($cv_appr_data['trainee_period_start']))." - ".date('Y/m/d', strtotime($cv_appr_data['trainee_period_end'])):''); ?>">
...
<script>
    var goto_record_list = function(hospital){
        localStorage.setItem('hospital_filter', hospital)        
        if(location.host == 'localhost'){
            $url = 'http://'+location.host+'/pci/doctor/doctor_record_list';
        }else{
            $url = 'http://'+location.host+'/doctor/doctor_record_list';
        }
    ...
    function embed_document_track(document_id, file_name){
        ...
        $.ajax({
            url: `${_base_url}doctor/track_viewer`,
            type: 'POST',
            global: false,
            dataType: 'json',
    ...
    function get_weekly_request(week){
        ...
        $.ajax({
            url: `${_base_url}doctor/get_weekly_request`,
            type: 'GET',            
            dataType: 'json',
