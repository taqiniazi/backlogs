...
.tox-edit-area html body p{
    ...
    .sec_title.t_id a.checv_up_down, .sec_title.p_id a.checv_up_down_cusotm {
        position: absolute;
        top: 50%;
        margin-top: -13px;
        right: 25px;
...
@media screen and (max-width: 640px) {
        ...
        .sec_title.p_id a.checv_up_down, .sec_title.p_id2 a.checv_up_down, .sec_title.r_id a.checv_up_down, .sec_title.r_id2 a.checv_up_down, .sec_title.t_id a.checv_up_down, .sec_title.p_id a.checv_up_down_cusotm {
            top: 20px;
            right: 11px;
        }
                ...
                <div class="form-group col-md-2 text-right nopadding-right" style="float: right;">
                        <div class="form_input_container" data-key="gender" style="background: white;">
                            <select class="form_input" style="margin-top: 0 !important;" onchange="updateStatus(this)" name="changeStatus" id="changeStatus">
                                ...
                                <option value="Embedding" <?php echo ($request_query[0]->request_code_status == "Embedding") ? "selected":""; ?>>Embedding</option>
                                <option value="Microtomy" <?php echo ($request_query[0]->request_code_status == "Microtomy") ? "selected":""; ?>>Microtomy</option>
                    ...
                    <div class="col-md-10 text-right nopadding-right">
                    ...
                    <form class="tg-formtheme" id="doctor_update_personal_record" method="post">
                        <div class="col-md-12 form-group" style="padding-right: 0;">
                            <div class="sec_title p_id form-group">
                               ...
                               $p_resultother=get_table_data("patient_other_details","patient_id=".$request_query[0]->patient_id);
							   //print "<pre>";
							   //print_r($p_result);
							   //print "</pre>";	
                                ...
                                <table class="custom-table info_nndn2" style="margin-bottom: 0; width:98%">
                                    <tr style="box-shadow:0px 0px 0px 0px !important;">
                                        <td style="width:40%">
                                            ...
                                            <span  style="font-weight: 500; display:inline-block; margin-top: 12px;"><?php echo $p_result[0]->first_name; ?> <?php print $p_result[0]->last_name; if($p_result[0]->medicare_card_no=='') { print " (PRIVATE)"; } else { print "";} ?></span>
                                ...
                                <input type="hidden" name="patient_id" id="patient_id" value="<?php echo $row2->id?>" />
                                            ...
                                            <div id="edit-view-patient" >
                                                ...
                                                <fieldset>
                                                            ...
                                                            <div class="tg-formtheme">
                                                                <fieldset>
                                                                    <div class="tg-inputicon">
                                                                        <input type="text" name="f_name" class="typeahead form_input fname patient_fname" placeholder="First Name" readonly value="<?= $row->f_name; ?>" readonly>
                                                                    </div>
                                                                </fieldset>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <input id="first_name" readonly type="text" name="f_name" class="form_input fname" placeholder="First Name" value="<?php /*echo $row->f_name; */?>">
                                                        </div>
                                                        <?php /*$json['f_name'] = $row->f_name; */?>
                                                    </div>-->
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="sur_name">
                                                            ...
                                                            <div class="tg-formtheme">
                                                                <fieldset>
                                                                    <div class="tg-inputicon">
                                                                        <input id="sur_name" type="text" name="sur_name" class="typeahead form_input fname patient_lname" placeholder="Last Name" value="<?= $row->sur_name; ?>" readonly>
                                                                    </div>
                                                                </fieldset>
                                                            </div>
<!--                                                            <input id="sur_name" type="text" readonly name="sur_name" class="form_input" placeholder="Surname" value="--><?php //print $p_result[0]->last_name; ?><!--">-->
                                                        </div>
                                                        <!-- <label></label> -->
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="dob">
                                                            ...
                                                            <input type="text" readonly name="dob" id="dob" class="form_input"
                                                    ...
                                                    <?php
                                                    $color_status = 'orange';
                                                    if (!empty($p_resultother[0]->mrn_number)) {
                                                        $color_status = 'green';
                                                    } elseif (!empty($p_resultother[0]->mrn_number)) {
                                                        $color_status = 'blue';
                                                    }
                                                    ?>

                                                    <div class="form-group col-md-3" style="display:none">
                                                        <label for="nhs_number">MRN Number - CR0010</label>
                                                        ...
                                                        <input type="text" readonly class="form_input" id="nhs_number" name="nhs_number" placeholder="MRN Number" value="<?php print $p_resultother[0]->mrn_number; ?>">
                                                        </div>
                                                        <?php $json['nhs_number'] = $p_resultother[0]->mrn_number; ?>
                                                    </div>
                                                    ...
                                                    <!-- <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="postcode">
                                                            ...
                                                            <input type="text" readonly class="form_input" id="p_id_1" name="p_id_1" placeholder="Patient ID 1" value="<?= $p_result[0]->p_id_1; ?>">
                                                        </div>
                                                    </div> -->
                                                    ...
                                                    <!-- <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="postcode">
                                                            ...
                                                            <input type="text" readonly class="form_input" id="p_id_2" name="p_id_2" placeholder="Patient ID 2" value="<?= $p_result[0]->p_id_2; ?>">
                                                        </div>
                                                    </div> -->
                                                    ...
                                                    ?>
                                                     <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container"
                                                            ...
                                                            <input type="text" readonly class="form_input"
                                                    ...
                                                    ?>
                                                     <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="patient_city">
                                                            ...
                                                            <input type="text" readonly class="form_input" id="patient_city"
                                                    ...
                                                    ?>
                                                     <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="postcode">
                                                            ...
                                                            <input type="text" readonly class="form_input" id="postcode"
                                                    ...
                                                    <?php
                                                    $color_status = 'orange';
                                                    if (!empty($p_result[0]->medicare_card_no)) {
                                                        $color_status = 'green';
                                                    } elseif (!empty($p_result[0]->medicare_card_no)) {
                                                        $color_status = 'blue';
                                                    }
                                                    ?>
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="medicare_card_no">
                                                            ...
                                                            <input type="text" readonly class="form_input" id="medicare_card_no"
                                                    ...
                                                    <?php
                                                    $color_status = 'orange';
                                                    if (!empty($p_resultother[0]->health_fund_code)) {
                                                        $color_status = 'green';
                                                    } elseif (!empty($p_result[0]->health_fund_code)) {
                                                        $color_status = 'blue';
                                                    }
                                                    ?>
                                                    <div class="form-group col-md-3">
                                                        <label for="health_fund_code">Health Fund Code</label>
                                                        <div class="form_input_container" data-key="health_fund_code">
                                                            <div class="radial_btn_container change_status_color">
                                                                <svg class="svg_health_fund_code" width="26" height="26">
                                                                    <circle cx="13" cy="13" r="12"
                                                                            stroke="<?php echo $color_status; ?>"
                                                                            fill-opacity="0" stroke-width="1"/>
                                                                    <circle cx="13" cy="13" r="7"
                                                            ...
                                                            <input type="text" readonly class="form_input" id="health_fund_code"
                                                                   name="health_fund_code" placeholder="Health Fund Code" value="<?php echo $p_resultother[0]->health_fund_code;?>"
                                                                   >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <?php
                                                    $color_status = 'orange';
                                                    if (!empty($p_resultother[0]->policy_number)) {
                                                        $color_status = 'green';
                                                    } elseif (!empty($p_result[0]->policy_number)) {
                                                        $color_status = 'blue';
                                                    }
                                                    ?>
                                                    <div class="form-group col-md-3" style="display:none" >
                                                        <label for="policy_number">Policy Number</label>
                                                        <div class="form_input_container" data-key="policy_number">
                                                            <div class="radial_btn_container change_status_color">
                                                                <svg class="svg_policy_number" width="26" height="26">
                                                                    <circle cx="13" cy="13" r="12"
                                                                            stroke="<?php echo $color_status; ?>"
                                                                            fill-opacity="0" stroke-width="1"/>
                                                                    <circle cx="13" cy="13" r="7"
                                                            ...
                                                            <input type="text" readonly class="form_input" id="policy_number"
                                                                   name="policy_number" placeholder="Policy Number" value="<?php echo $p_resultother[0]->policy_number;?>"
                                                                   >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <?php
                                                    $color_status = 'orange';
                                                    if (!empty($p_resultother[0]->health_fund_name)) {
                                                        $color_status = 'green';
                                                    } elseif (!empty($p_result[0]->health_fund_name)) {
                                                        $color_status = 'blue';
                                                    }
                                                    ?>
                                                    <div class="form-group col-md-3" style="display:none">
                                                        <label for="health_fund_name">Health Fund Name</label>
                                                        <div class="form_input_container" data-key="health_fund_name">
                                                            <div class="radial_btn_container change_status_color">
                                                                <svg class="health_fund_name" width="26" height="26">
                                                                    <circle cx="13" cy="13" r="12"
                                                                            stroke="<?php echo $color_status; ?>"
                                                                            fill-opacity="0" stroke-width="1"/>
                                                                    <circle cx="13" cy="13" r="7"
                                                            ...
                                                            <input type="text" readonly class="form_input" id="health_fund_name"
                                                                   name="health_fund_name" placeholder="Health Fund Name" value="<?php echo $p_resultother[0]->health_fund_name;?>"
                                                                   >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <?php
                                                    $color_status = 'orange';
                                                    if (!empty($p_resultother[0]->pensioner_card_number)) {
                                                        $color_status = 'green';
                                                    } elseif (!empty($p_result[0]->pensioner_card_number)) {
                                                        $color_status = 'blue';
                                                    }
                                                    ?>
                                                    <div class="form-group col-md-3" style="display:none">
                                                        <label for="pensioner_card_number">Pensioner Card Number</label>
                                                        <div class="form_input_container" data-key="pensioner_card_number">
                                                            <div class="radial_btn_container change_status_color">
                                                                <svg class="pensioner_card_number" width="26" height="26">
                                                                    <circle cx="13" cy="13" r="12"
                                                                            stroke="<?php echo $color_status; ?>"
                                                                            fill-opacity="0" stroke-width="1"/>
                                                                    <circle cx="13" cy="13" r="7"
                                                            ...
                                                            <input type="text" readonly class="form_input" id="pensioner_card_number"
                                                                   name="pensioner_card_number" placeholder="Pensioner Card Number" value="<?php echo $p_resultother[0]->pensioner_card_number;?>"
                                                                   >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <?php
                                                    $color_status = 'orange';
                                                    if (!empty($p_resultother[0]->health_care_card_number)) {
                                                        $color_status = 'green';
                                                    } elseif (!empty($p_result[0]->health_care_card_number)) {
                                                        $color_status = 'blue';
                                                    }
                                                    ?>
                                                    <div class="form-group col-md-3" style="display:none">
                                                        <label for="health_care_card_number">Health Care Card Number</label>
                                                        <div class="form_input_container" data-key="health_care_card_number">
                                                            <div class="radial_btn_container change_status_color">
                                                                <svg class="health_care_card_number" width="26" height="26">
                                                                    <circle cx="13" cy="13" r="12"
                                                                            stroke="<?php echo $color_status; ?>"
                                                                            fill-opacity="0" stroke-width="1"/>
                                                                    <circle cx="13" cy="13" r="7"
                                                            ...
                                                            <input type="text" readonly class="form_input" id="health_care_card_number"
                                                                   name="health_care_card_number" placeholder="Health Care Card Number" value="<?php echo $p_resultother[0]->health_care_card_number;?>"
                                                                   >
                                                        </div>
                                                    </div>
...
$Usersgetdatils = getRecords("AES_DECRYPT(first_name, '" . DATA_KEY . "') AS first_name,AES_DECRYPT(last_name, '" . DATA_KEY . "') AS last_name, profile_picture_path", "users", array("id" => $path_id[0]->user_id));
...
?>
                                ...
                                <table class="custom-table info_nndn2" style="margin-bottom: 0; width:98%">
                                    <tr style="box-shadow:0px 0px 0px 0px !important;">
                                        ...
                                        <td><span style="font-weight: 500">Practitioner: <span><img src="<?php echo base_url();?><?php echo $Usersgetdatils[0]->profile_picture_path;?>" class="img-fluid img-circle" width="40" title="<?php echo $Usersgetdatils[0]->first_name;?> <?php echo $Usersgetdatils[0]->last_name;?>"></span></span></td>
...
<div class="col-sm-3 nopadding">
                                            ...
                                            <div class="col-sm-3 nopadding">
                                                <div class="table-view-container">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-9 ">
                                                            <div class="table-view-heading">Practitioner</div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3" style="display:none">
                                                ...
                                                <div class="form_input_container" data-key="serial_number">
                                                    ...
                                                    <input id="serial_number" readonly type="text" name="serial_number"
                                            ...
                                            <div class="form-group col-md-3" style="display:none">
                                                ...
                                                <div class="form_input_container" data-key="track_number">
                                                    ...
                                                    <input type="text" readonly class="form_input" id="track_number"
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="lab_number">
                                                    ...
                                                    <input type="text" class="form_input" id="lab_number"
                                            ...
                                            <div class="form-group col-md-3" style="display:none">
                                                ...
                                                <div class="form_input_container" data-key="pci_number">
                                                    ...
                                                    <input id="pci_number" readonly type="text" name="pci_number"
 ...
 <?php
                                            ...
                                            <div class="form-group col-md-3">
                                                <label for="date_taken">Request Date</label>
                                                <div class="form_input_container" data-key="date_taken">
                                                    ...
                                                    ?>
                                                    <input class="form_input" readonly type="text" name="date_taken"
 ...
 <?php
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="hospital_no">
                                                            <div class="radial_btn_container change_status_color">
                                                             ...
                                                             <select class="form_input hos_name clinic_list" id="hos_id" onchange="save_case_request(this.id)" name="hos_id">
                                                        ...
                                                        if (!empty($get_hos_names) && is_array($get_hos_names)) :
															...
															{																
                                                                $selected = '';
                                                                if ($hos_val->id == $hospital_data[0]->id) 
																{
                                                                    $selected = 'selected';
                                                                }
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="lab_name">
                                                    ...
                                                    <select class="form_input lab_name" readonly id="lab_id" name="lab_name">
                                                        <option value="0">Choose</option>
                                                        <?php
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="organisation_identifier">
                                                    ...
                                                    <input type="text" readonly class="form_input" id="organisation_identifier"
                                            ...
                                            ?>
                                            <div class="form-group col-md-3">
                                                <label for="pathologist">Practitioner - Pcr6990 &nbsp;
                                                    <a href="javascript:void(0);" class="add_new_pathologist" title="Add New Practitioner" data-toggle="modal" data-target="#add_pathologist_modal">
                                                        <i class="fa fa-plus"></i>
                                                    </a>
                                                </label>
                                                <div class="form_input_container" data-key="pathologist">
                                                    ...
                                                    <input type="hidden" value="<?php print $Usersgetdatils[0]->id; ?>" name="assigned_user_id" />
                                                   <input type="text" class="form_input" readonly id="location" name="location"
                                                           placeholder="Location" value="<?php echo $Usersgetdatils[0]->first_name;?> <?php echo $Usersgetdatils[0]->last_name;?>" disabled> 
 ...
 <?php
                                            ...
                                            <div class="form-group col-md-3" style="display:none">
                                                ...
                                                <div class="form_input_container" data-key="specimen_nature">
                                                    ...
                                                    <input type="text" class="form_input" readonly id="specimen_nature"
                                            ...
                                            <div class="form-group col-md-3">
                                                <label for="date_received_bylab">Lab Receive - Pcr0770</label>
                                                <div class="form_input_container" data-key="date_received_bylab">
                                                    ...
                                                    ?>
                                                    <input class="form_input" readonly type="text" name="date_received_bylab"
                                            ...
                                            <div class="form-group col-md-3">
                                                <label for="date_sent_touralensis">Lab Release Date</label>
                                                <div class="form_input_container" data-key="date_sent_touralensis">
                                                    ...
                                                    ?>
                                                    <input type="text" readonly name="date_sent_touralensis" class="form_input"
                                           ...
                                           $color_status = 'orange';
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="courier_no">
                                                    ...
                                                    <input type="text" readonly class="form_input" id="emis_number"
                               ...
                               <li class="cust_dd_show hidden">
                                ...
                                <li class="cust_dd_show hidden">                             
                                 <a href="<?php echo site_url() . '/doctor/add_further_work_new/' . $request_query[0]->uralensis_request_id; ?>" class="tg-detailsicon"  title="Add Further Work">
                                    <span title="Add Further Work" class="tg-notificationtag">0</span>
                                    ...
                                    <table class="table custom-table table-striped datatables dataTable no-footer">
                                        ...
                                        if (isset($files) && is_array($files)) {
                                            ...
                                            foreach ($files as $file) {
                                                ...
                                                $path1 = base_url() . 'uploads/' . $file->file_name;
                                                $path2 = base_url() . 'lab_uploads/' . $file->file_name;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($modify_ext === 'png' || $modify_ext === 'jpg') { ?>
                                                            <div style="display:none;"
                                                                ...
                                                                <img src="<?= $srcVal; ?>">
                                                                <hr>
                                                                <button class="btn btn-warning" id="close_hover_image">
                                                                    Close
                                                                </button>
                                                            </div>
                                                        <?php } ?>
                                                    ...
                                                    <td>Admin<?php //echo ucwords($file->user); ?></td>
                                                    <td><?php
                                    ...
                                    <form class="form" method="post" id="check_auth_pass_form">
                                        ...
                                        if (!empty($split_surname)) {
                                            ...
                                            <div class="form-group ura-surname-field"
                                                ...
                                                <p>Check patient first name from Request Form as final ID check.</p>
                                                <?php
                                                $dom_array = array();
                                                ...
                                                if (!empty($splitted_name)) {
                                                    foreach ($splitted_name as $key_name => $key_value) 
													{
                                                        ...
                                                        echo '<input maxlength="1" type="text" value="' . $key_value . '" data-namekey="' . $key_name . '" data-namevalue="' . $key_value . '" name="checksurname[]"> ';
                                                    }
                                                }
                                                ?>
                                            ...
                                            <div class="ura-pin-area2">
                                                <div class="form-group ura-password-fields" style="display:none">
                                                    <p>Enter Your Pin To Publish This Report.</p>
                                                    <input autofocus maxlength="1" type="password" value="1" id="auth_pass1"
                                                           name="auth_pass1">
                                                    <input maxlength="1" type="password" value="2" name="auth_pass2">
                                                    <input maxlength="1" type="password" value="3" name="auth_pass3">
                                                    <input maxlength="1" type="password" value="4" name="auth_pass4">
                        ...
                        <div class="modal-body">
                            <div class="assign_doctor_and_authorize">
                                ...
                                <form id="doctor_assign_form">
                                    <select class="form-control select2 select_multiple_imgs" name="assign_doctor" id="assign_doctor" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body edt_modal_bdy">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group ">
                                ...
                                <input type="text" name="email" placeholder="Enter email address" class="form-control check_email2" required>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                        <h5 class="modal-title">Clinicians List : </h5>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-sm-12">
                        <table class="table custom-table" id="request-clinician-table">
                            <thead>
                            <!-- <tr>
...
<div id="add_pathologist_modal" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add New Practitioner</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div id="add_patient" class="modal custom-modal fade editPatient" role="dialog" data-backdrop="static" data-keyboard="false">
...
<script>
    ...
    function LoadPatientDetails(row){
        ...
        $.ajax({
            type: 'POST',
            url: _base_url + "doctor/LoadPatientDetails",
            data: {'pid' : pid,'recordId':recordId,[csrf_name]: csrf_hash},
            dataType: 'json',
            success: function(data) {
                if(data.status === 'success'){
                    $('.editPatient').html(data.modalView);
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#tb3', function(){
            $('.tab_li').removeClass('active');
        ...
        $(document).on('click', '#tb5', function(){
            $('.tab_li').removeClass('active');
...
var stickytop = headerne.offsetTop;

function myFunction() {
  if (window.pageYOffset > stickytop) {
    headerne.classList.add("stickytop");
  } else {
    headerne.classList.remove("stickytop");
  }
}
</script>
