                        ...
                        <div class="col-md-12 form-group" style="padding-right: 0;">
                            <div class="sec_title p_id form-group">
							  ...
							  // echo $p_result->nhs_number;						   
                                ...
                                <!-- <div> -->
                                <a href="javascript:;" onclick="LoadPatientDetails(this)" class="custom_patient_edit edit_icon checv_up_down_cusotm" data-recordId="<?php echo $record_id; ?>" data-pid="<?php echo $request_query[0]->patient_id; ?>" style="margin-right: 30px;">
...
<!--                                                            <input id="sur_name" type="text" onblur="save_case_request(this.id)" name="sur_name" class="form_input" placeholder="Surname" value="--><?php //print $p_result[0]->last_name; ?><!--">-->
                                                    ...
                                                    <div class="form-group col-md-3" style="display:none">
                                                        ...
                                                        <input type="text" onblur="save_case_request(this.id)" class="form_input" id="nhs_number" name="nhs_number" placeholder="MRN Number" value="<?php print $p_resultother[0]->mrn_number; ?>">
                                                        </div>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="health_fund_code">
                                                            ...
                                                            <input type="text" onblur="save_case_request(this.id)" class="form_input" id="health_fund_code"
                                                    ...
                                                    <div class="form-group col-md-3" style="display:none" >
                                                        ...
                                                        <div class="form_input_container" data-key="policy_number">
                                                            ...
                                                            <input type="text" onblur="save_case_request(this.id)" class="form_input" id="policy_number"
                                                    ...
                                                    <div class="form-group col-md-3" style="display:none">
                                                        ...
                                                        <div class="form_input_container" data-key="health_fund_name">
                                                            ...
                                                            <input type="text" onblur="save_case_request(this.id)" class="form_input" id="health_fund_name"
                                                    ...
                                                    <div class="form-group col-md-3" style="display:none">
                                                        ...
                                                        <div class="form_input_container" data-key="pensioner_card_number">
                                                            ...
                                                            <input type="text" onblur="save_case_request(this.id)" class="form_input" id="pensioner_card_number"
                                                    ...
                                                    <div class="form-group col-md-3" style="display:none">
                                                        ...
                                                        <div class="form_input_container" data-key="health_care_card_number">
                                                            ...
                                                            <input type="text" onblur="save_case_request(this.id)" class="form_input" id="health_care_card_number"
 ...
 <?php
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="pathologist">
                                                   ...
                                                   <input type="text" class="form_input" onblur="save_case_request(this.id)" id="location" name="location"
...
<!--                                </div>-->
    ...
    <div class="tg-haslayout" <?=$disableDiv?>>
