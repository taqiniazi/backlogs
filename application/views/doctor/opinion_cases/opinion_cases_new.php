...
<style type="text/css">
    ...
    #doctor_opinion_record_list_table_wrapper .row:nth-child(2){margin:0;}
    #doctor_opinion_record_list_table_filter{margin-right: 10px;}
</style>
...
<div class="container-fluid">
    ...
    <div class="tg-haslayout">
        ...
        <?php } ?>
        <div class="row">
            <div class="col-xs-11 col-sm-11 col-md-11 col-lg-11" style="float: right;">
                <div class="tg-filterhold" style="float: right; width: auto;">
                    <ul class="tg-filters record-list-filters">
                        
                        <li class="tg-statusbar tg-flagcolor" style="padding: 5px;margin-left: 0px;">
...
<!--                        </li>-->
                        <li class="tg-statusbar tg-flagcolor custome-flagcolors nobefore search_li" style="padding: 0">
                                <?php
                                $attributes = array('method' => 'POST', 'id'=>'search_opinion_type_form');
                                echo form_open('doctor/doctor_opinion_cases', $attributes); ?>
                            <div class="input-group">
                                <select name="sr_opinion_status" class="form-control" onchange="search_by_type()" style="padding: 10px;">
                                    <optgroup label="Opinion">
                                    <option value="inbound" <?php echo ($sr_opinion_status == 'inbound'?'selected':''); ?> > Inbound</option>
                                    <option value="outbound" <?php echo ($sr_opinion_status == 'outbound'?'selected':''); ?> > Outbound</option>
                                    </optgroup>
                                </select>
                            </div>
                            <?php echo form_close(); ?>
                        ...
                        <li class="tg-statusbar tg-flagcolor">
                            <div class="tg-checkboxgroup tg-checkboxgroupvtwo" style="margin-top:2px;">
    ...
    <div class="row report_listing">
        <div class="col-md-12">
            ...
            <?php if($sr_opinion_status == 'inbound'){ ?>
...
<!--                    </th>-->
                ...
                <?php
                $flag_count = 11;
//                echo "<pre>";print_r($opinion_cases);exit;
                            ...
                            <div class="comments_icon">
                                ...
                                if(!empty($row->ura_rec_opinion_status)){
                                    ...
                                    if($opinion_status=='Pending'){
                                        ...
                                        $status_text = "Pending Acceptance";
                                        ...
                                        <input type="hidden" name="opinion_id" value="<?php echo $row->ura_opinion_id; ?>">
                                        <input type="hidden" name="opinion_status" value="Accepted">
                                        <!-- <button class=" btn btn-info btn-sm btn-rounded"></button> -->
                                        <a style="color:#000;" class="opinion_status_btn" href="javascript:void(0)" data-toggle="modal" data-target="#reject_opinion_request" onclick="set_opinion_id_rej(<?php echo $row->ura_opinion_id; ?>)" >
                                            
                                            <i class="fa fa-dot-circle-o text-danger" style="font-size: 18px; color: <?php echo $badge_color; ?>;"></i> Reject
...
<!--                                            <span class="badge  --><?php //echo $badge_color; ?><!--">--><?php //echo $status_text; ?><!--</span>-->
                                        ...
                                        <!-- <a href="<?php echo $a_href; ?>" <?php echo $data_toggle; ?> <?php echo $data_target; ?> <?php echo $data_onclick; ?> class="opinion_status_btn">
                                            <i class="fa fa-dot-circle-o" tyle="font-size: 35px; color: <?php echo $badge_color; ?>;"></i> <?php echo $opinion_status; ?>
                                        </a> -->
                                   <?php }
...
<!--                            --><?php //echo $row->ura_opinion_last_date; ?>
                        ...
                        <td>
                            <a  class="edit-icon" href="<?php echo $a_href; ?>">
...
<!--                    <th class="status_up"> Status </th>-->
                ...
                <?php
                $flag_count = 11;
                foreach ($opinion_cases_requested as $row) {
                    // $row_code = '';
...
<!--                        </td>-->
                        <td>
                            <div class="comments_icon">
                                ...
                                $status_text = "";
                                $data_toggle = "data-toggle='modal'";
                                $data_target = "data-target='#opinion_request_detail'";
                                $data_onclick = "";
                                $a_href = "javascript:void(0);";
                                $opinion_status_req = getOpinionsRequestedCount($row->ura_opinion_req_id);
                                if(!empty($opinion_status_req)){
                                    $opinion_status = $opinion_status_req['status'];
                                    if($opinion_status=='Pending'){
                                        // $badge_color = $opinion_status_req['badge_color'];
                                        // $status_text = $opinion_status_req['text'];
                                        $badge_color = "#ff6a1a";
                                        $status_text = "Pending";
//                                        $data_toggle = 'data-toggle="modal"';
//                                        $data_target = 'data-target="#update_opinion_status"';
//                                        $data_onclick = 'onclick="set_opinion_id('.$row->ura_opinion_id.')"'; ?>
                                        <a style="color:#000; position: relative;" class="opinion_status_btn" id="<?php echo $row->ura_opinion_req_id; ?>" href="<?php echo $a_href; ?>" <?php echo $data_toggle; ?> <?php echo $data_target; ?> <?php echo $data_onclick; ?> title="<?php echo $opinion_status_req['text']; ?>">
                                            <!-- <i class="lnr lnr-file-empty" style=""></i> -->

                                            <!-- <span class="badge  <?php echo $badge_color; ?>"><?php echo $status_text; ?></span> -->
                                            <i class="fa fa-dot-circle-o" style="font-size: 18px; color: <?php echo $badge_color; ?>;"></i> <?php echo $status_text; ?> 
                                            <span class="badge badge-pill opinion_count_pending" style="background-color: #ffbc34;"><?php echo $opinion_status_req['filled']; ?>-<?php echo $opinion_status_req['total']; ?> </span>
                                        </a>
                                    <?php }else{
                                        if($opinion_status== 'Accepted'){
                                            // $badge_color = $opinion_status_req['badge_color'];
...
//                                            }
                                        ...
                                        <a style="color:#000; position: relative;" class="opinion_status_btn" id="<?php echo $row->ura_opinion_req_id; ?>" href="<?php echo $a_href; ?>" <?php echo $data_toggle; ?> <?php echo $data_target; ?> <?php echo $data_onclick; ?> title="<?php echo $opinion_status_req['text']; ?>">
                                            <i class="fa fa-dot-circle-o" style="font-size: 18px; color: <?php echo $badge_color; ?>; font-weight: bold" ></i> <?php echo $status_text; ?> 
                                            <span class="badge badge-pill opinion_count" style="background-color: <?php echo $badge_color;?>" ><?php echo $opinion_status_req['filled']; ?>-<?php echo $opinion_status_req['total']; ?></span>
<!--                                            <span class="badge  --><?php //echo $badge_color; ?><!--">--><?php //echo $status_text; ?><!--</span>-->
                                        </a>
                                    <?php }
...
<!--    </div>-->
                ...
                <div class="modal-body">
                    <section class="form-group">
                        <div class="row">
                            ...
                            <input type="hidden" id="ad_opinion_id" name="ad_opinion_id" value="">
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
    ...
    <div id="opinion_request_detail" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header" style="padding-top: 10px;">
                    <h5 class="modal-title">Opinion Request Detail</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <section class="form-group">
                        <div class="row">
                            <input type="hidden" id="rej_opinion_id" name="opinion_id" value="">
                            <table class="table table-striped table-bordered r_opinion_request_display"
                                   id="r_opinion_request_display">
                                <th></th>
                            </table>
                        </div>
                    </section>
...
<script>
    ...
    function search_by_type(){
        document.getElementById('search_opinion_type_form').submit();
