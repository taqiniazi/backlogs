...
<script>
    jQuery(document).ready(function () {
        ...
        $('#doctor_record_review_cases, #doctor_opinion_record_list_table, #doctor_opinion_requested_list_table, #teaching_case_table, #further_work_table_completed, #further_work_table_requested, #mdt_table_post, #mdt_table_pending, #doctor_invoice_table').DataTable({
            ordering: false,
            stateSave: true,
            "processing": true,
...
function generatePDFREPORT(){
           // let patientID = $(document).find('#patient_id').val();
            ...
            $.ajax({
                ...
                url: "https://pathhub.fnqhpathology.com/doctor/generate_report2/"+requestID,
                data: {},
                dataType: "json",
                success: function (response){
