    ...
    public function Footer()
	 {
        ...
        $footer_text_val = "<table style='font-size:12px; text-align:center;'>
		<tr><td><hr></td></tr><tr><td><center>&nbsp;&nbsp;Reported by: Dr Fiona Makowski, Anatomic Pathologist; fiona.makowski@fnqhpathology.com</center></td></tr>
		<tr><td><br></td></tr><tr><td style='font-size:12px; padding-left:40%'><center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FNQH Pathology Pty Ltd, ABN 12345667</center></td></tr><tr><td><br></td></tr>
		<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$footer_count."</td></tr></table>";
        $this->SetY(-37);
...
foreach ($query2 as $key => $row2) :
    if($row2->specimen_diagnosis_description !='')
	{
        ...
        $html .= '<tr><td width="97%">'.($key + 1).' '.$new_dio . '</td>
		 <td width="3%"></td> 
           </tr>';            
    }
...
$html .= '<br><table>
    ...
    foreach ($query2 as $specimen_data) {
       // $specimen_result_clinical = str_replace("\n", '<br />', $specimen_data->specimen_clinical_history);
		...
		{
            $html .='<tr><td width="97%">'.$specimen_result_clinical.'</td><td width="3%"></td></tr> <tr>
				<td ><br></td><td ><br></td>                                
			</tr>                                
			</tr>';
            $specimen_count++;
...
$count = 1;
$html .= '</table><br /><br />
    <table><tr><td colspan="2"><strong>Macroscopic </strong></td></tr> <tr>
		 <td></td>
                <td ><br></td>
...
foreach ($query2 as $row3) 
{
    ...
    if($Result_macro != '' || $Result_micro != ''){
            $html .= '<tr>
			<td width="3%">'.$s_count.'.</td>
                <td width="92%">'.$Result_macro.'</td>
...
$html .= '<br /><br />
    <table><tr><td colspan="2"><strong>Microscopic </strong></td></tr> <tr>
                 <td></td>
                <td ><br></td>
...
<tr>
    ...
    <tr>
        <td><b>Supplementary Report ' . $supp_count . ' &nbsp; | &nbsp; Requested Time : ' . $additional_work_time2 . ' </b></td>
    </tr>
    <br />
    <tr>
...
if(!file_exists($_SERVER['DOCUMENT_ROOT']."/uploads/reports_pdf/".$request_id."_".date('Y').'.pdf')){
