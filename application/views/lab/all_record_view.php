          ...
          foreach ($query as $row) 
          {
            ...
            {}else{ ?>
                <tr class="<?php //echo $row_code; ?>" onclick="window.location.href=<?php echo site_url() . '/doctor/doctor_record_detail_old/' . $row->uralensis_request_id.$request_type; ?>">
                  ...
                  <?php if($row->specimen_publish_status == 0)
                    { ?>
				  ...
				  <?php //echo substr($row->spec_grp_name,0,1); ?>H / G</a>
        <?php }else{ echo '-';} ?>
        </td>
                  <td class="<?php // echo $row_code; ?>">
                 ...
                 <td class="text-center">
                  ...
                  <?php if($row->specimen_publish_status == 1)
                    { ?>
                    <center><a target="_blank" href="<?= site_url().'/doctor/generate_report/'.$row->uralensis_request_id; ?>"><img src="<?= base_url("assets/img/pdf.png"); ?>" title="Pdf View"></a></center>
