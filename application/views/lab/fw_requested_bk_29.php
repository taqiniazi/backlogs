        ...
        <table id="further_work_table_requested" class="table table-stripped custom-table">
            ...
            <tbody>
                ...
                if (!empty($requested)) {
					...
					{
						/*print $t_id=$row->test_id;
						print "select name as test_name from laboratory_tests where id='$t_id'";
						$query_a=$this->db->query("select name as test_name from laboratory_tests where id='$t_id'"); 
						//$row_t=$query_a->result(); 
						foreach ($query_a->result_array() as $row_t)
						{
							print $row_t->test_name;
						}
						print $row_t[0]->test_name;
						print "====";*/
                        ?>
                        <tr>
