...
<div class="row">
 ...
 <path d="M21.8,33.6c1-3.6,2.1-7.1,3.1-10.7c2.7,0.3,5.2,1.2,7.4,2.7c2.7,1.8,4.6,4.1,5.5,7.2c0.2,0.8,0.4,1.7,0.4,2.6
  ...
  C0.1,32.6,0.1,30.2,0.1,27.8L0.1,27.8z"></path></svg></a>
   ...
   <li>
   <a href="#" class="filter_by_status_btn" title="Embedding"><svg x="0px" y="0px" width="43.8px" height="33.3px" viewBox="0 0 43.8 33.3">
  ...
  v2c-0.4,0.1-0.8,0.2-1.4,0.3v-2.1C26.9,11.3,27.3,11.3,27.8,11.2"></path>
    ...
    <li class="cust_dd_show hidden"><a href="#" class="filter_by_status_btn" title="Microtomy"><svg x="0px" y="0px" width="17.3px" height="45.1px" viewBox="0 0 17.3 45.1">
  ...
  c2-2,4.4-3.3,7.2-3.8C17.3,0.2,18.2,0.1,19,0"></path>
   ...
   <li class="cust_dd_show hidden">
   <a href="https://pathhub.fnqhpathology.com/Slide_label" class="filter_by_status_btn" title="Further Work"><svg x="0px" y="0px" width="44.7px" height="44.7px" viewBox="0 0 44.7 44.7">
...
<li class="cust_dd_show hidden">
   <a href="<?php echo base_url();?>Slide_label" class="filter_by_status_btn" title="Bar Code"><i class="fa-2x fa fa-barcode text-success"></i></a>
   </li>
   <li class="cust_dd">
