...
<div class="record_publish_listing">
   ...
   <table id="slide_label_list" class="table table-striped" cellspacing="0" width="100%" style="margin-top:10px !important">
      <thead>
         <tr>
            <th colspan="8">
               <a href="javascript:print_barcode(1);" id="btn_barcode" class="btn btn-info hide">Request</a>
               ...
               <a href="javascript:print_barcode(2);" id="btn_sp_pot" class="btn btn-info hide">Specimen Pot</a>
               <!-- <a href="javascript:print_custom_barcode();" id="btn_sp_pot" class="btn btn-success hide">Specimen Pot</a> -->
               <!-- <a href="javascript:format_barcode();" id="btn_sp_request" class="btn btn-info hide">Request</a> -->
               <a href="javascript:download_barcode(1);" id="btn_download_request" class="btn btn-info hide">Multislide</a>
               <a href="javascript:download_barcode(2);" id="btn_download_request1" class="btn btn-info hide">Cassette</a>
            </th>
         </tr>
         <tr>
            <th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class='row'>
            ...
            <center>
                <div class='barcode_wrap' style='border: 1px solid #777;width: 340px;padding: 8px;border-radius: 25px;'>    
                    <center><img src="#" id="barcode_img" alt="Barcode">
                            <table>
                            <!-- <tr><td class='text-center' id='br_digi_number'></td></tr> -->
                            <tr><td class='text-center' id='br_lab_number'></td></tr>
                            <tr><td class='text-center' id='br_patient'></td></tr>
                            <tr><td class='text-center' id='br_test'></td></tr>
                        </table>
                        </center>
                    </div>
                </div>
...
<input type="hidden" id="customSearch" value="<?php echo (isset($_GET['lno']) && $_GET['lno'] != '') ? $_GET['lno'] : "" ?>"/>
<a href="#" id="downloadFile" style="display: none;" download=""></a><br/>
<script>
