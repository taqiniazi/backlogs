...
<div class="row">
  ...
  C0.1,32.6,0.1,30.2,0.1,27.8L0.1,27.8z"></path>
              ...
              <div class="process-step">
                ...
                <button id="embedding" onclick="select_status('Embedding', this);" type="button" class="btn btn-circle"> <svg x="0px" y="0px" width="43.8px" height="33.3px" viewBox="0 0 43.8 33.3">
          ...
          <div class="process">
            ...
            <div class="process-row mid">
              <div class="process-step" style="width:20%;">
                ...
                <div> <img src="<?php echo base_url() ?>assets/img/processDiagram/arrow-empty-01.svg" style="width:40%; height:26%; margin:0 auto;"> </div>
  ...
  H8.7c0.7-6.4,5.7-11.5,12-12.4v4H24V8.3c6.7,0.6,12,5.8,12.8,12.5h-4.4V24h4.4C36,30.6,30.7,35.8,24,36.4z"></path>
                ...
                <div style="margin-left: 40px;"> <img src="<?php echo base_url() ?>assets/img/processDiagram/arrow-up-01.svg" style="width:40px; height:40%; margin:20px auto 0"> </div>
              </div>
