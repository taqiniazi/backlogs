...
class Incident_LedgerModel extends CI_Model
{
    ...
    public function getAllAdminUser() {
        ...
        //                   where user_id in (select user_id from users_groups inner join `groups` on `groups`.`id` = users_groups.group_id where groups.group_type IN ('LA','DE','LS','D')) and group_id is NULL";
    ...
    public function getCounts($userID)
    {
        ...
        //     $this->db->where('lab_id', $laboratoryId);
        // }
        $this->db->join("incident_ledger_assignee", 'incident_ledger_assignee.assignee_ticket_id = incident_ledger.	ticket_id', 'INNER');
        $newRES = $this->db->get('incident_ledger');
        ...
        $closedCntRES = $this->db->get('incident_ledger');
        ...
        $inprogressRES = $this->db->get('incident_ledger');
        ...
        $pendingCntRES = $this->db->get('incident_ledger');
