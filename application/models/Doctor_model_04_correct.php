...
//        echo $this->db->last_query(); exit;
    ...
    public function doctor_record_detail($id)
    {
        ...
        request_datetime, publish_datetime,
        publish_datetime_modified, emis_number,patients.nhs_number, lab_number, hos_number, sur_name,
    ...
    public function display_further_work_model_requested_new()
    {
        ...
        $filter = " AND request.lab_id IN ($labIds)";
        $user_where = "";
        //$user_where = "further_work.doctor_id = ".$user_id." AND";
        // Old one which is getting data from the further work
        // $query = $this->db->query("SELECT further_work.fw_id,further_work.furtherwork_date, 
        ...
        $query = $this->db->query("SELECT further_work.fw_id,further_work.furtherwork_date,further_work.fw_status, 
            ...
            FROM further_work
                ...
                LEFT JOIN laboratory_tests as lt ON lt.id=fwd.test_id
                LEFT JOIN users as requester ON requester.id=sp.created_by
        ...
        /* AND users.id = $user_id this need to change */
...
//        echo $this->db->last_query(); exit;
    ...
    public function specimen_block_list($id){
        ...
        $sql = "SELECT block.block_no FROM specimen INNER JOIN specimen_blocks block on block.specimen_id=specimen.specimen_id AND specimen.request_id = $id GROUP BY block_no ORDER BY id ASC";
        $query = $this->db->query($sql);
        return $query->result();
    }
