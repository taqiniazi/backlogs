...
class Slide_label_model extends CI_Model {
    ...
    public function get_unpublished_data($table, $select = null, $type, $lab_id)
	{
		...
		$this->db->join('request_assignee rq_as', 'rq_as.request_id = rq.uralensis_request_id', 'inner');
		...
		$this->db->join('request_specimen rs', 'rs.rs_request_id = rq.uralensis_request_id', 'left');
