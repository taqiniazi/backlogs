 ...
 */
$config['site_title']                 = "pathhub.fnqhpathology.com";       // Site Title, example.com
...
$config['lockout_time']               = 30*60;                 /* The number of seconds to lockout an account due to exceeded attempts
