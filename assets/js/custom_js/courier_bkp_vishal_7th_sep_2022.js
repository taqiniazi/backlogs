...
function formatUsersList(user) {
    ...
    var base_url = "http://localhost/fnqhpathology/";
...
$(document).ready(function () {
    ...
    $("#sender_search,#receiver_search").on("change", function () {
        ...
        if(dataId=="add-user"){
            ...
            if(dataId!=""){
                ...
                // if(parseInt($('#dropdownchange').val()) >= 1){
                    ...
                    // });
                // }
                // $("#sender_search").val(dataText.sender_id);
                // $("#receiver_search").val(dataText.receiver_id);
    ...
    $(document).on("click", ".edt-tckt", function (elem) {
        ...
        $("#courier_company").val(dataText.courier_company).trigger('click');
